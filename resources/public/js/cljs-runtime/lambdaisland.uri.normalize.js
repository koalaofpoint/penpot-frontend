...
import "./lambdaisland.uri.platform.js";
...
var G__29937 = next_offset;
var G__29938 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,cur_char);
offset__$1 = G__29937;
res = G__29938;
continue;
}
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29896_SHARP_){
return ["%",lambdaisland.uri.platform.byte__GT_hex(p1__29896_SHARP_)].join('');
...
var encode_char = (function (p1__29897_SHARP_){
var G__29903 = p1__29897_SHARP_;
if(cljs.core.truth_(cljs.core.re_find(char_class,p1__29897_SHARP_))){
return lambdaisland.uri.normalize.percent_encode.cljs$core$IFn$_invoke$arity$1(G__29903);
} else {
return G__29903;
}
});
...
return clojure.string.replace(s,/(%[0-9A-Fa-f]{2})+/,(function (p__29906){
var vec__29907 = p__29906;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29907,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29907,(1),null);
...
var G__29943 = (i + (3));
var G__29944 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,lambdaisland.uri.normalize.percent_encode.cljs$core$IFn$_invoke$arity$2(lambdaisland.uri.normalize.percent_decode(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s,i,(i + (3)))),new cljs.core.Keyword(null,"query","query",-1288509510)));
i = G__29943;
res = G__29944;
continue;
} else {
...
var G__29946 = (i + (1));
var G__29947 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s,i,(i + (1))));
i = G__29946;
res = G__29947;
continue;
} else {
var increment = ((lambdaisland.uri.normalize.high_surrogate_QMARK_(lambdaisland.uri.platform.char_code_at(s,i)))?(2):(1));
var G__29950 = (i + increment);
var G__29951 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,lambdaisland.uri.normalize.percent_encode.cljs$core$IFn$_invoke$arity$2(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s,i,(i + increment)),new cljs.core.Keyword(null,"query","query",-1288509510)));
i = G__29950;
res = G__29951;
continue;
