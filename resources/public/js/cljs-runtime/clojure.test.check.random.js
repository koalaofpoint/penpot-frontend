import "./cljs_env.js";
import "./cljs.core.js";
import "./clojure.test.check.random.doubles.js";
import "./clojure.test.check.random.longs.js";
...
var clojure$test$check$random$IRandom$rand_long$dyn_34530 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_34530(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_34535 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_34535(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_34536 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_34536(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_34537 = (function (rng,n){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_34537(rng,n);
}
});
...
var G__34509 = z;
if(((24) > (function (){var G__34510 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__34510) : clojure.test.check.random.longs.bit_count.call(null,G__34510));
})())){
return clojure.test.check.random.longs.bit_xor(G__34509,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__34509;
}
});
...
var G__34539 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__34540 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__34539;
ret = G__34540;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__34517){
var map__34518 = p__34517;
var map__34518__$1 = cljs.core.__destructure_map(map__34518);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34518__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__34521 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34521,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34521,(1),null);
