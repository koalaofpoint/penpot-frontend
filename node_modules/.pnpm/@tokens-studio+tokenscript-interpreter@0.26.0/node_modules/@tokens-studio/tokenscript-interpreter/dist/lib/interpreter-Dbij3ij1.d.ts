import { x as Token, A as ASTNode, I as ISymbolType, a as Config, G as ReferenceRecord } from './types-DSZPf9oj.js';

/**
 * Union type for serialized error data that can be passed in error data objects.
 * Used when wrapping errors from catch blocks.
 */
type SerializedError = Error | LanguageError | string | {
    message: string;
    stack?: string;
};
declare function isLanguageError(error: unknown): error is LanguageError;
declare function isLexerError(error: unknown): error is LexerError;
declare function isParserError(error: unknown): error is ParserError;
declare function isInterpreterError(error: unknown): error is InterpreterError;
declare function isProcessorError(error: unknown): error is ProcessorError;
/**
...
declare enum FunctionsErrorCode {
...
declare enum InterpreterErrorCode {
...
type AllErrorCodes = LexerErrorCode | ParserErrorCode | InterpreterErrorCode | OperationsErrorCode | SymbolsErrorCode | FunctionsErrorCode | ConfigErrorCode | ProcessorErrorCode | ColorErrorCode | UnitErrorCode;
...
declare class LanguageError extends Error {
...
declare class LexerError extends LanguageError {
    readonly code: LexerErrorCode;
    constructor(code: LexerErrorCode, options?: ErrorOptions);
}
declare class ParserError extends LanguageError {
    readonly code: ParserErrorCode;
    constructor(code: ParserErrorCode, options?: ErrorOptions);
}
declare class InterpreterError extends LanguageError {
    readonly code: InterpreterErrorCodes;
    constructor(code: InterpreterErrorCodes, options?: ErrorOptions);
}
declare class ProcessorError extends LanguageError {
...
declare class Interpreter {
    ...
    private ast;
    config: Config;
    constructor(input: Parser | ASTNode | null, options?: {
        references?: ReferenceRecord | Map<string, any>;
        symbolTable?: SymbolTable;
        config?: Config;
    });
    importReferences(references?: ReferenceRecord | Map<string, any>): void;
    getReference(key: string): ISymbolType | undefined;
    setReference(key: string, value: ISymbolType): void;
    setAst(ast: ASTNode | null): void;
    resetSymbolTable(): void;
    getSymbol(name: string): ISymbolType | null;
    setSymbol(name: string, value: ISymbolType): void;
    coerceValue(constructorSymbol: ISymbolType, valueSymbol: ISymbolType): ISymbolType | undefined;
    private visit;
     ...
     */
    private visitIdentifierNode;
    private visitUnaryOpNode;
    private visitListNode;
    private visitImplicitListNode;
    private visitReferenceNode;
    private visitHexColorNode;
    private visitBooleanNode;
    private visitNullNode;
    private visitElementWithUnitNode;
    private visitFunctionCallNode;
    private visitAssignNode;
    private visitReassignNode;
    private visitAttributeAccessNode;
    private visitStatementListNode;
    private visitReturnNode;
    private visitWhileNode;
    private visitIfNode;
    interpret(): InterpreterResult;
}

export { type AllErrorCodes as A, SymbolsErrorCode as B, type ColorErrorData as C, serializeError as D, type ErrorOptions as E, type FunctionsErrorData as F, UnitErrorCode as G, InterpreterError as I, LanguageError as L, type OperationsErrorData as O, ProcessorError as P, type SerializedError as S, type UnitErrorData as U, LexerError as a, ParserError as b, Interpreter as c, type InterpreterResult as d, Lexer as e, Parser as f, type ConfigErrorData as g, type InterpreterErrorData as h, type LexerErrorData as i, type ParserErrorData as j, type ProcessorErrorData as k, type SymbolsErrorData as l, ColorErrorCode as m, ConfigErrorCode as n, FunctionsErrorCode as o, parseExpression as p, InterpreterErrorCode as q, isInterpreterError as r, isLanguageError as s, isLexerError as t, isParserError as u, isProcessorError as v, LexerErrorCode as w, OperationsErrorCode as x, ParserErrorCode as y, ProcessorErrorCode as z };
