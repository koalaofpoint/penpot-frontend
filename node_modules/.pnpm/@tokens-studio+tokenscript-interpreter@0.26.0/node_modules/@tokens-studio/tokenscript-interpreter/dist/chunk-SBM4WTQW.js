import { SupportedFormats, ReservedKeyword, UNINTERPRETED_KEYWORDS } from './chunk-BMZ5NY7J.js';
import { type } from 'arktype';

// src/interpreter/errors/codes/color.ts
var ColorErrorCode = /* @__PURE__ */ ((ColorErrorCode2) => {
  ColorErrorCode2["INITIALIZER_CRASHED"] = "COLOR_INITIALIZER_CRASHED";
  ColorErrorCode2["INITIALIZER_CONSTRUCT_FAILED"] = "COLOR_INITIALIZER_CONSTRUCT_FAILED";
  ColorErrorCode2["INITIALIZER_NOT_FOUND"] = "COLOR_INITIALIZER_NOT_FOUND";
  ColorErrorCode2["CONVERSION_TARGET_NOT_FOUND"] = "COLOR_CONVERSION_TARGET_NOT_FOUND";
  ColorErrorCode2["SOURCE_URI_NOT_FOUND"] = "COLOR_SOURCE_URI_NOT_FOUND";
  ColorErrorCode2["TARGET_URI_NOT_FOUND"] = "COLOR_TARGET_URI_NOT_FOUND";
  ColorErrorCode2["CONVERSION_ERROR"] = "COLOR_CONVERSION_ERROR";
  ColorErrorCode2["STRING_VALUE_ASSIGNMENT"] = "COLOR_STRING_VALUE_ASSIGNMENT";
  ColorErrorCode2["ATTRIBUTE_CHAIN_TOO_LONG"] = "COLOR_ATTRIBUTE_CHAIN_TOO_LONG";
  ColorErrorCode2["MISSING_SPEC"] = "COLOR_MISSING_SPEC";
  ColorErrorCode2["MISSING_SCHEMA"] = "COLOR_MISSING_SCHEMA";
  ColorErrorCode2["MISSING_ATTRIBUTE_SCHEMA"] = "COLOR_MISSING_ATTRIBUTE_SCHEMA";
  ColorErrorCode2["INVALID_ATTRIBUTE_TYPE"] = "COLOR_INVALID_ATTRIBUTE_TYPE";
  ColorErrorCode2["INVALID_ALPHA_VALUE"] = "COLOR_INVALID_ALPHA_VALUE";
  return ColorErrorCode2;
})(ColorErrorCode || {});
...
function isValidHex(value) {
  ...
  if (!(hexPart.length === 3 || hexPart.length === 4 || hexPart.length === 6 || hexPart.length === 8)) return false;
...
var mathFunctions = {
  ...
  sign: (arg) => over(arg, Math.sign, "sign"),
...
//# sourceMappingURL=chunk-SBM4WTQW.js.map
//# sourceMappingURL=chunk-SBM4WTQW.js.map