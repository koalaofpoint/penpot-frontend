...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_28482 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_28482(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_28483 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_28483(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_28484 = (function (reader,ch){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_28484(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_28486 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_28486(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_28487 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_28487(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_28488 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_28488(reader);
}
});
...
var G__28515 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__28516 = s.append(c);
c = G__28515;
s = G__28516;
continue;
}
