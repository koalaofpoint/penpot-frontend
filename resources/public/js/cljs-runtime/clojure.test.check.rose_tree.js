...
return cljs.core.cons(cljs.core.first(s),(function (){var G__34546 = (n - (1));
var G__34547 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__34546,G__34547) : clojure.test.check.rose_tree.exclude_nth.call(null,G__34546,G__34547));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__34549 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__34549) : f.call(null,G__34549));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34548_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__34548_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__34548_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34550_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__34550_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__34550_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__34551_SHARP_){
var G__34552 = clojure.test.check.rose_tree.root(p1__34551_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__34552) : pred.call(null,G__34552));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__5503__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__34553(s__34554){
return (new cljs.core.LazySeq(null,(function (){
var s__34554__$1 = s__34554;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__34554__$1);
if(temp__5825__auto__){
var xs__6385__auto__ = temp__5825__auto__;
var vec__34560 = cljs.core.first(xs__6385__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34560,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34560,(1),null);
var iterys__5499__auto__ = ((function (s__34554__$1,vec__34560,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__34553_$_iter__34555(s__34556){
return (new cljs.core.LazySeq(null,((function (s__34554__$1,vec__34560,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function (){
var s__34556__$1 = s__34556;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__34556__$1);
if(temp__5825__auto____$1){
var s__34556__$2 = temp__5825__auto____$1;
...
var child = cljs.core._nth(c__5501__auto__,i__34557);
cljs.core.chunk_append(b__34558,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__34621 = (i__34557 + (1));
i__34557 = G__34621;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__34558),clojure$test$check$rose_tree$permutations_$_iter__34553_$_iter__34555(cljs.core.chunk_rest(s__34556__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__34558),null);
}
} else {
var child = cljs.core.first(s__34556__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__34553_$_iter__34555(cljs.core.rest(s__34556__$2)));
}
} else {
return null;
}
...
});})(s__34554__$1,vec__34560,rose,index,xs__6385__auto__,temp__5825__auto__))
,null,null));
});})(s__34554__$1,vec__34560,rose,index,xs__6385__auto__,temp__5825__auto__))
;
var fs__5500__auto__ = cljs.core.seq(iterys__5499__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__5500__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5500__auto__,clojure$test$check$rose_tree$permutations_$_iter__34553(cljs.core.rest(s__34554__$1)));
} else {
var G__34622 = cljs.core.rest(s__34554__$1);
s__34554__$1 = G__34622;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34563_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__34563_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__34563_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34565_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__34565_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__34565_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__34569 = f;
var G__34570 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__34569,G__34570) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__34569,G__34570));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__34571 = f;
var G__34572 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__34571,G__34572) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__34571,G__34572));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {
