...
var len__5749__auto___25943 = arguments.length;
var i__5750__auto___25944 = (0);
while(true){
if((i__5750__auto___25944 < len__5749__auto___25943)){
args__5755__auto__.push((arguments[i__5750__auto___25944]));

var G__25946 = (i__5750__auto___25944 + (1));
i__5750__auto___25944 = G__25946;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq25872){
...
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25873,G__25874,seq25872__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__25910_SHARP_){
return (!((cljs.core.meta(p1__25910_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25917__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e25918){var _e__25159__auto__ = e25918;
return false;
}})();
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
...
}catch (e25921){var _e__25159__auto__ = e25921;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__25926 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__25927 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__25927);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25928__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__25926);
}});
...
var temp__5823__auto___25970 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5823__auto___25970)){
var managed_print_level_25974 = temp__5823__auto___25970;
var _STAR_print_level_STAR__orig_val__25933_25976 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__25934_25977 = managed_print_level_25974;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__25934_25977);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__25929_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__25929_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__25933_25976);
}} else {
job_fn();
}
