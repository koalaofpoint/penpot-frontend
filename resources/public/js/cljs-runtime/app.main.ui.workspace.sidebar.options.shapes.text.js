...
import "./rumext.v2.js";
goog.provide('app.main.ui.workspace.sidebar.options.shapes.text');
app.main.ui.workspace.sidebar.options.shapes.text.options_STAR_ = (function app$main$ui$workspace$sidebar$options$shapes$text$options_STAR_(props_56065){
var file_id = props_56065.fileId;
var libraries = props_56065.libraries;
var page_id = props_56065.pageId;
var shape = props_56065.shape;
...
var state_map = (cljs.core.truth_(app.main.features.active_feature_QMARK_(cljs.core.deref(app.main.store.state),"text-editor/v2"))?rumext.v2.deref(app.main.refs.workspace_v2_editor_state):rumext.v2.deref(app.main.refs.workspace_editor_state));
var editor_state = ((cljs.core.not(app.main.features.active_feature_QMARK_(cljs.core.deref(app.main.store.state),"text-editor/v2")))?cljs.core.get.cljs$core$IFn$_invoke$arity$2(state_map,id):null);
var editor_instance = (cljs.core.truth_(app.main.features.active_feature_QMARK_(cljs.core.deref(app.main.store.state),"text-editor/v2"))?rumext.v2.deref(app.main.refs.workspace_editor):null);
var fill_values = app.main.data.workspace.texts.current_text_values(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"editor-state","editor-state",579582138),editor_state,new cljs.core.Keyword(null,"editor-instance","editor-instance",-1602615018),editor_instance,new cljs.core.Keyword(null,"shape","shape",1190694006),shape,new cljs.core.Keyword(null,"attrs","attrs",-2090668713),cljs.core.conj.cljs$core$IFn$_invoke$arity$2(app.common.types.text.text_fill_attrs,new cljs.core.Keyword(null,"fills","fills",902966780))], null));
var text_values = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.select_keys(shape,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"grow-type","grow-type",-908344411)], null)),cljs.core.select_keys(shape,app.main.ui.workspace.sidebar.options.menus.fill.fill_attrs),app.main.data.workspace.texts.current_root_values(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"shape","shape",1190694006),shape,new cljs.core.Keyword(null,"attrs","attrs",-2090668713),app.common.types.text.root_attrs], null)),app.main.data.workspace.texts.current_paragraph_values(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"editor-state","editor-state",579582138),editor_state,new cljs.core.Keyword(null,"editor-instance","editor-instance",-1602615018),editor_instance,new cljs.core.Keyword(null,"shape","shape",1190694006),shape,new cljs.core.Keyword(null,"attrs","attrs",-2090668713),app.common.types.text.paragraph_attrs], null)),app.main.data.workspace.texts.current_text_values(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"editor-state","editor-state",579582138),editor_state,new cljs.core.Keyword(null,"editor-instance","editor-instance",-1602615018),editor_instance,new cljs.core.Keyword(null,"shape","shape",1190694006),shape,new cljs.core.Keyword(null,"attrs","attrs",-2090668713),app.common.types.text.text_node_attrs], null))], 0));
return rumext.v2.jsxs(rumext.v2.Fragment,{'children':[rumext.v2.jsx(app.main.ui.workspace.sidebar.options.menus.layer.layer_menu_STAR_,{'ids':ids,'type':type,'appliedTokens':applied_tokens,'values':layer_values}),rumext.v2.jsx(app.main.ui.workspace.sidebar.options.menus.measures.measures_menu_STAR_,{'ids':ids,'type':type,'values':measure_values,'appliedTokens':applied_tokens,'shapes':shapes}),rumext.v2.jsx(app.main.ui.workspace.sidebar.options.menus.layout_container.layout_container_menu,{'type':type,'ids':ids,'values':layout_container_values,'applied-tokens':applied_tokens,'multiple':false}),(cljs.core.truth_((function (){var and__5023__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(ids),(1));
