...
declare class TokenSymbol extends BaseSymbolType {
    ...
    subType: string;
    value: TokenValue;
    constructor(subType: string, value: TokenValue | Record<string, ISymbolType> | TokenSymbol | null, config?: Config);
    validValue(val: any): boolean;
    toString(): string;
...
interface SpecProperty {
    type: "number" | "string" | "token" | "object";
    url?: string;
...
export { type ASTNode as A, Config as C, type ISymbolType as I, Operations as O, type ReferenceRecord as R, SupportedFormats as S, type Token as T, UNINTERPRETED_KEYWORDS as U, ReservedKeyword as a, TokenType as b, type ReferenceRecordValue as c };
