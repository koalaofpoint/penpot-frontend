...
lambdaisland.uri.authority_regex = /^(([^:]*)(:(.*))?@)?(\[[0-9a-fA-F:]+\]|[^:]*)(:(\d*))?$/;
...
var G__34283 = user;
var G__34283__$1 = (cljs.core.truth_((function (){var and__5023__auto__ = user;
if(cljs.core.truth_(and__5023__auto__)){
return password;
} else {
return and__5023__auto__;
}
})())?[cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__34283),":",cljs.core.str.cljs$core$IFn$_invoke$arity$1(password)].join(''):G__34283);
var G__34283__$2 = (cljs.core.truth_(user)?[cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__34283__$1),"@"].join(''):G__34283__$1);
var G__34283__$3 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__34283__$2),cljs.core.str.cljs$core$IFn$_invoke$arity$1(host)].join('')
;
if(cljs.core.truth_(port)){
return [G__34283__$3,":",cljs.core.str.cljs$core$IFn$_invoke$arity$1(port)].join('');
} else {
return G__34283__$3;
}
} else {
 ...
 */
lambdaisland.uri.uri_str = (function lambdaisland$uri$uri_str(p__34288){
var map__34289 = p__34288;
var map__34289__$1 = cljs.core.__destructure_map(map__34289);
var scheme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34289__$1,new cljs.core.Keyword(null,"scheme","scheme",90199613));
var user = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34289__$1,new cljs.core.Keyword(null,"user","user",1532431356));
var password = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34289__$1,new cljs.core.Keyword(null,"password","password",417022471));
var host = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34289__$1,new cljs.core.Keyword(null,"host","host",-1558485167));
var port = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34289__$1,new cljs.core.Keyword(null,"port","port",1534937262));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34289__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34289__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var fragment = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34289__$1,new cljs.core.Keyword(null,"fragment","fragment",826775688));
var authority = lambdaisland.uri.authority_string(user,password,host,port);
var G__34290 = "";
var G__34290__$1 = (cljs.core.truth_(scheme)?[G__34290,cljs.core.str.cljs$core$IFn$_invoke$arity$1(scheme),":"].join(''):G__34290);
var G__34290__$2 = (cljs.core.truth_(authority)?[G__34290__$1,"//",authority].join(''):G__34290__$1);
var G__34290__$3 = [G__34290__$2,cljs.core.str.cljs$core$IFn$_invoke$arity$1(path)].join('')
;
var G__34290__$4 = (cljs.core.truth_(query)?[G__34290__$3,"?",cljs.core.str.cljs$core$IFn$_invoke$arity$1(query)].join(''):G__34290__$3);
if(cljs.core.truth_(fragment)){
return [G__34290__$4,"#",cljs.core.str.cljs$core$IFn$_invoke$arity$1(fragment)].join('');
} else {
return G__34290__$4;
}
});
...
(lambdaisland.uri.URI.prototype.cljs$core$ILookup$_lookup$arity$2 = (function (this__5323__auto__,k__5324__auto__){
var self__ = this;
var this__5323__auto____$1 = this;
return this__5323__auto____$1.cljs$core$ILookup$_lookup$arity$3(null,k__5324__auto__,null);
}));

(lambdaisland.uri.URI.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5325__auto__,k34298,else__5326__auto__){
var self__ = this;
...
(lambdaisland.uri.URI.prototype.cljs$core$ICounted$_count$arity$1 = (function (this__5327__auto__){
var self__ = this;
var this__5327__auto____$1 = this;
return (8 + cljs.core.count(self__.__extmap));
}));

(lambdaisland.uri.URI.prototype.cljs$core$IHash$_hash$arity$1 = (function (this__5319__auto__){
var self__ = this;
...
return (-701916260 ^ cljs.core.hash_unordered_coll(coll__5320__auto__));
...
(lambdaisland.uri.URI.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this34299,other34300){
var self__ = this;
var this34299__$1 = this;
return (((!((other34300 == null)))) && ((((this34299__$1.constructor === other34300.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this34299__$1.scheme,other34300.scheme)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this34299__$1.user,other34300.user)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this34299__$1.password,other34300.password)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this34299__$1.host,other34300.host)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this34299__$1.port,other34300.port)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this34299__$1.path,other34300.path)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this34299__$1.query,other34300.query)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this34299__$1.fragment,other34300.fragment)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this34299__$1.__extmap,other34300.__extmap)))))))))))))))))))));
}));

(lambdaisland.uri.URI.prototype.cljs$core$IMap$_dissoc$arity$2 = (function (this__5333__auto__,k__5334__auto__){
var self__ = this;
var this__5333__auto____$1 = this;
if(cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"path","path",-188191168),null,new cljs.core.Keyword(null,"password","password",417022471),null,new cljs.core.Keyword(null,"fragment","fragment",826775688),null,new cljs.core.Keyword(null,"port","port",1534937262),null,new cljs.core.Keyword(null,"host","host",-1558485167),null,new cljs.core.Keyword(null,"query","query",-1288509510),null,new cljs.core.Keyword(null,"user","user",1532431356),null,new cljs.core.Keyword(null,"scheme","scheme",90199613),null], null), null),k__5334__auto__)){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core._with_meta(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,this__5333__auto____$1),self__.__meta),k__5334__auto__);
} else {
return (new lambdaisland.uri.URI(self__.scheme,self__.user,self__.password,self__.host,self__.port,self__.path,self__.query,self__.fragment,self__.__meta,cljs.core.not_empty(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(self__.__extmap,k__5334__auto__)),null));
}
}));

(lambdaisland.uri.URI.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5330__auto__,k34298){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k34298);

}
}));

(lambdaisland.uri.URI.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5331__auto__,k__5332__auto__,G__34297){
var self__ = this;
var this__5331__auto____$1 = this;
var pred__34322 = cljs.core.keyword_identical_QMARK_;
var expr__34323 = k__5332__auto__;
if(cljs.core.truth_((pred__34322.cljs$core$IFn$_invoke$arity$2 ? pred__34322.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"scheme","scheme",90199613),expr__34323) : pred__34322.call(null,new cljs.core.Keyword(null,"scheme","scheme",90199613),expr__34323)))){
return (new lambdaisland.uri.URI(G__34297,self__.user,self__.password,self__.host,self__.port,self__.path,self__.query,self__.fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__34322.cljs$core$IFn$_invoke$arity$2 ? pred__34322.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"user","user",1532431356),expr__34323) : pred__34322.call(null,new cljs.core.Keyword(null,"user","user",1532431356),expr__34323)))){
return (new lambdaisland.uri.URI(self__.scheme,G__34297,self__.password,self__.host,self__.port,self__.path,self__.query,self__.fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__34322.cljs$core$IFn$_invoke$arity$2 ? pred__34322.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"password","password",417022471),expr__34323) : pred__34322.call(null,new cljs.core.Keyword(null,"password","password",417022471),expr__34323)))){
return (new lambdaisland.uri.URI(self__.scheme,self__.user,G__34297,self__.host,self__.port,self__.path,self__.query,self__.fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__34322.cljs$core$IFn$_invoke$arity$2 ? pred__34322.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"host","host",-1558485167),expr__34323) : pred__34322.call(null,new cljs.core.Keyword(null,"host","host",-1558485167),expr__34323)))){
return (new lambdaisland.uri.URI(self__.scheme,self__.user,self__.password,G__34297,self__.port,self__.path,self__.query,self__.fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__34322.cljs$core$IFn$_invoke$arity$2 ? pred__34322.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"port","port",1534937262),expr__34323) : pred__34322.call(null,new cljs.core.Keyword(null,"port","port",1534937262),expr__34323)))){
return (new lambdaisland.uri.URI(self__.scheme,self__.user,self__.password,self__.host,G__34297,self__.path,self__.query,self__.fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__34322.cljs$core$IFn$_invoke$arity$2 ? pred__34322.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"path","path",-188191168),expr__34323) : pred__34322.call(null,new cljs.core.Keyword(null,"path","path",-188191168),expr__34323)))){
return (new lambdaisland.uri.URI(self__.scheme,self__.user,self__.password,self__.host,self__.port,G__34297,self__.query,self__.fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__34322.cljs$core$IFn$_invoke$arity$2 ? pred__34322.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"query","query",-1288509510),expr__34323) : pred__34322.call(null,new cljs.core.Keyword(null,"query","query",-1288509510),expr__34323)))){
return (new lambdaisland.uri.URI(self__.scheme,self__.user,self__.password,self__.host,self__.port,self__.path,G__34297,self__.fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__34322.cljs$core$IFn$_invoke$arity$2 ? pred__34322.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"fragment","fragment",826775688),expr__34323) : pred__34322.call(null,new cljs.core.Keyword(null,"fragment","fragment",826775688),expr__34323)))){
return (new lambdaisland.uri.URI(self__.scheme,self__.user,self__.password,self__.host,self__.port,self__.path,self__.query,G__34297,self__.__meta,self__.__extmap,null));
} else {
return (new lambdaisland.uri.URI(self__.scheme,self__.user,self__.password,self__.host,self__.port,self__.path,self__.query,self__.fragment,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5332__auto__,G__34297),null));
}
}
}
}
...
(lambdaisland.uri.URI.prototype.cljs$core$ISeqable$_seq$arity$1 = (function (this__5336__auto__){
var self__ = this;
...
(lambdaisland.uri.URI.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5322__auto__,G__34297){
var self__ = this;
var this__5322__auto____$1 = this;
return (new lambdaisland.uri.URI(self__.scheme,self__.user,self__.password,self__.host,self__.port,self__.path,self__.query,self__.fragment,G__34297,self__.__extmap,self__.__hash));
}));

(lambdaisland.uri.URI.prototype.cljs$core$ICollection$_conj$arity$2 = (function (this__5328__auto__,entry__5329__auto__){
var self__ = this;
...
(lambdaisland.uri.URI.prototype.call = (function (unused__14253__auto__){
var self__ = this;
var self__ = this;
var G__34328 = (arguments.length - (1));
switch (G__34328) {
case (1):
...
(lambdaisland.uri.URI.prototype.apply = (function (self__,args34303){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args34303)));
}));
...
(lambdaisland.uri.URI.cljs$lang$ctorPrSeq = (function (this__5369__auto__){
return (new cljs.core.List(null,"lambdaisland.uri/URI",null,(1),null));
}));

(lambdaisland.uri.URI.cljs$lang$ctorPrWriter = (function (this__5369__auto__,writer__5370__auto__){
return cljs.core._write(writer__5370__auto__,"lambdaisland.uri/URI");
}));
 ...
 */
lambdaisland.uri.map__GT_URI = (function lambdaisland$uri$map__GT_URI(G__34301){
var extmap__5365__auto__ = (function (){var G__34335 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__34301,new cljs.core.Keyword(null,"scheme","scheme",90199613),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"user","user",1532431356),new cljs.core.Keyword(null,"password","password",417022471),new cljs.core.Keyword(null,"host","host",-1558485167),new cljs.core.Keyword(null,"port","port",1534937262),new cljs.core.Keyword(null,"path","path",-188191168),new cljs.core.Keyword(null,"query","query",-1288509510),new cljs.core.Keyword(null,"fragment","fragment",826775688)], 0));
if(cljs.core.record_QMARK_(G__34301)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__34335);
} else {
return G__34335;
}
})();
return (new lambdaisland.uri.URI(new cljs.core.Keyword(null,"scheme","scheme",90199613).cljs$core$IFn$_invoke$arity$1(G__34301),new cljs.core.Keyword(null,"user","user",1532431356).cljs$core$IFn$_invoke$arity$1(G__34301),new cljs.core.Keyword(null,"password","password",417022471).cljs$core$IFn$_invoke$arity$1(G__34301),new cljs.core.Keyword(null,"host","host",-1558485167).cljs$core$IFn$_invoke$arity$1(G__34301),new cljs.core.Keyword(null,"port","port",1534937262).cljs$core$IFn$_invoke$arity$1(G__34301),new cljs.core.Keyword(null,"path","path",-188191168).cljs$core$IFn$_invoke$arity$1(G__34301),new cljs.core.Keyword(null,"query","query",-1288509510).cljs$core$IFn$_invoke$arity$1(G__34301),new cljs.core.Keyword(null,"fragment","fragment",826775688).cljs$core$IFn$_invoke$arity$1(G__34301),null,cljs.core.not_empty(extmap__5365__auto__),null));
});
...
var vec__34342 = matches;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34342,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34342,(1),null);
var scheme = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34342,(2),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34342,(3),null);
var authority = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34342,(4),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34342,(5),null);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34342,(6),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34342,(7),null);
var ___$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34342,(8),null);
var fragment = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34342,(9),null);
...
var vec__34348 = matches;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34348,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34348,(1),null);
var user = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34348,(2),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34348,(3),null);
var password = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34348,(4),null);
var host = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34348,(5),null);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34348,(6),null);
var port = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34348,(7),null);
...
var vec__34358 = lambdaisland.uri.match_uri(uri);
var scheme = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34358,(0),null);
var authority = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34358,(1),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34358,(2),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34358,(3),null);
var fragment = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34358,(4),null);
if(cljs.core.truth_(authority)){
var vec__34361 = lambdaisland.uri.match_authority(authority);
var user = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34361,(0),null);
var password = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34361,(1),null);
var host = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34361,(2),null);
var port = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34361,(3),null);
return (new lambdaisland.uri.URI(scheme,user,password,host,port,path,query,fragment,null,null,null));
} else {
...
while(true){
var G__34374 = cljs.core.first(in$);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("/.",G__34374)){
if(cljs.core.next(in$)){
var G__34446 = cljs.core.next(in$);
var G__34447 = out;
in$ = G__34446;
out = G__34447;
continue;
...
var G__34448 = null;
var G__34449 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"/");
in$ = G__34448;
out = G__34449;
continue;
}
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("/..",G__34374)){
if(cljs.core.next(in$)){
var G__34450 = cljs.core.next(in$);
var G__34451 = cljs.core.vec(cljs.core.butlast(out));
in$ = G__34450;
out = G__34451;
continue;
} else {
var G__34452 = null;
var G__34453 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.vec(cljs.core.butlast(out)),"/");
in$ = G__34452;
out = G__34453;
continue;
}
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__34374)){
return clojure.string.join.cljs$core$IFn$_invoke$arity$1(out);
} else {
var G__34454 = cljs.core.next(in$);
var G__34455 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,cljs.core.first(in$));
in$ = G__34454;
out = G__34455;
continue;
...
args__5755__auto__.push((arguments[i__5750__auto___34457]));

var G__34459 = (i__5750__auto___34457 + (1));
i__5750__auto___34457 = G__34459;
continue;
} else {
}
break;
...
return lambdaisland.uri.join.cljs$core$IFn$_invoke$arity$variadic(argseq__5756__auto__);
});
...
/** @this {Function} */
(lambdaisland.uri.join.cljs$lang$applyTo = (function (seq34386){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq34386));
}));

lambdaisland.uri.decode_param_pair = (function lambdaisland$uri$decode_param_pair(param){
var vec__34392 = clojure.string.split.cljs$core$IFn$_invoke$arity$3(param,/=/,(2));
...
(lambdaisland.uri.query_string__GT_map.cljs$core$IFn$_invoke$arity$2 = (function (q,p__34405){
var map__34406 = p__34405;
var map__34406__$1 = cljs.core.__destructure_map(map__34406);
var multikeys = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__34406__$1,new cljs.core.Keyword(null,"multikeys","multikeys",-695183366),new cljs.core.Keyword(null,"duplicates","duplicates",1265485699));
var keywordize_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__34406__$1,new cljs.core.Keyword(null,"keywordize?","keywordize?",-234306912),true);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34406__$1,new cljs.core.Keyword(null,"into","into",-150836029));
if(clojure.string.blank_QMARK_(q)){
return into;
} else {
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m,p__34409){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__34413__$1)].join('')));

}
}),(function (){var or__5025__auto__ = into;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return cljs.core.PersistentArrayMap.EMPTY;
}
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2(lambdaisland.uri.decode_param_pair,clojure.string.split.cljs$core$IFn$_invoke$arity$2(q,/&/)));
}
}));
 ...
 *   `nil`.
 */
lambdaisland.uri.query_string__GT_seq = (function lambdaisland$uri$query_string__GT_seq(q){
if(clojure.string.blank_QMARK_(q)){
return null;
} else {
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(lambdaisland.uri.decode_param_pair,clojure.string.split.cljs$core$IFn$_invoke$arity$2(q,/&/));
}
});
/**
...
var encode_char = (function (p1__34425_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__34425_SHARP_)){
return "+";
} else {
if(cljs.core.truth_(cljs.core.re_find(/[^a-zA-Z0-9\-\._~@\\/]/,p1__34425_SHARP_))){
return lambdaisland.uri.normalize.percent_encode.cljs$core$IFn$_invoke$arity$1(p1__34425_SHARP_);
} else {
return p1__34425_SHARP_;
...
if(cljs.core.seq(m)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.interpose.cljs$core$IFn$_invoke$arity$2("&",cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__34426){
var vec__34427 = p__34426;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34427,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34427,(1),null);
if((v == null)){
 ...
 *   stringified.
 */
lambdaisland.uri.seq__GT_query_string = (function lambdaisland$uri$seq__GT_query_string(pairs){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.interpose.cljs$core$IFn$_invoke$arity$2("&",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__34430){
var vec__34431 = p__34430;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34431,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34431,(1),null);
return lambdaisland.uri.encode_param_pair(k,v);
}),pairs)));
});
/**
...
return lambdaisland.uri.assoc_query.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5756__auto__);
});

(lambdaisland.uri.assoc_query.cljs$core$IFn$_invoke$arity$variadic = (function (u,p__34436){
var map__34438 = p__34436;
var map__34438__$1 = cljs.core.__destructure_map(map__34438);
var kvs = map__34438__$1;
...
/** @this {Function} */
(lambdaisland.uri.assoc_query.cljs$lang$applyTo = (function (seq34434){
var G__34435 = cljs.core.first(seq34434);
var seq34434__$1 = cljs.core.next(seq34434);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34435,seq34434__$1);
}));
