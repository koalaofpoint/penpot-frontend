...
import "./instaparse.auto_flatten_seq.js";
...
var vec__76545 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76545,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76545,(1),null);
...
var vec__76549 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76549,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76549,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__76552 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76552,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76552,(1),null);
...
var temp__5823__auto__ = cljs.core.seq(instaparse.repeat.parse_from_index(grammar,initial_parser,text,segment,end__$1));
if(temp__5823__auto__){
var follow_ups = temp__5823__auto__;
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [parse,end__$1,follow_ups], null);
} else {
var G__76763 = cljs.core.next(parses__$1);
parses__$1 = G__76763;
continue;
}
...
var G__76561 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__76562 = G__76561;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76562,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76562,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76562,(2),null);
var selection = vec__76562;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__76561__$1 = G__76561;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__76568 = G__76561__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76568,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76568,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76568,(2),null);
var selection__$1 = vec__76568;
...
var G__76770 = cljs.core.long$(end__$1);
var G__76771 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__76772 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__76770;
parses__$1 = G__76771;
G__76561__$1 = G__76772;
continue;
...
var G__76578 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__76579 = G__76578;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76579,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76579,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76579,(2),null);
var selection = vec__76579;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__76578__$1 = G__76578;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__76586 = G__76578__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76586,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76586,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76586,(2),null);
var selection__$1 = vec__76586;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__76784 = cljs.core.long$(end__$1);
var G__76785 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__76786 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__76784;
parses__$1 = G__76785;
G__76578__$1 = G__76786;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__76604 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__76606 = G__76604;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76606,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76606,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76606,(2),null);
var selection = vec__76606;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__76604__$1 = G__76604;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__76617 = G__76604__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76617,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76617,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76617,(2),null);
var selection__$1 = vec__76617;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__76790 = cljs.core.long$(end__$1);
var G__76791 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__76792 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__76790;
parses__$1 = G__76791;
G__76604__$1 = G__76792;
continue;
...
if(cljs.core.truth_((function (){var fexpr__76670 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__76670.cljs$core$IFn$_invoke$arity$1 ? fexpr__76670.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__76670.call(null,output_format));
})())){
} else {
...
if(cljs.core.truth_((function (){var or__5025__auto__ = cljs.core.empty_QMARK_(header_results);
if(or__5025__auto__){
...
if(cljs.core.not((function (){var and__5023__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207));
if(and__5023__auto__){
var and__5023__auto____$1 = (function (){var G__76747 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__76746 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__76746.cljs$core$IFn$_invoke$arity$1 ? fexpr__76746.cljs$core$IFn$_invoke$arity$1(G__76747) : fexpr__76746.call(null,G__76747));
})();
