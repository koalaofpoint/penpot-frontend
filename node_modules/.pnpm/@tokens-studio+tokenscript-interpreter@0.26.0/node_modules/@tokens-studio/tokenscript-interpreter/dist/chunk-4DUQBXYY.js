  ...
  setupBuiltinFunctions() {
    ...
    this.registerFunction("round", (arg) => {
      if (arg instanceof NumberWithUnitSymbol) {
        return new NumberWithUnitSymbol(Math.round(arg.value), arg.unit);
      }
      if (!(arg instanceof NumberSymbol))
        throw new InterpreterError("FN_EXPECTS_TYPE_ARGUMENT" /* EXPECTS_TYPE_ARGUMENT */, {
          data: { functionName: "round", expectedType: "number", argumentPosition: "first" }
        });
      return new NumberSymbol(Math.round(arg.value));
    });
    this.registerFunction("abs", (arg) => {
      if (arg instanceof NumberWithUnitSymbol) {
        return new NumberWithUnitSymbol(Math.abs(arg.value), arg.unit);
      }
      if (!(arg instanceof NumberSymbol))
        throw new InterpreterError("FN_EXPECTS_TYPE_ARGUMENT" /* EXPECTS_TYPE_ARGUMENT */, {
    ...
    this.registerFunction("floor", (arg) => {
      if (arg instanceof NumberWithUnitSymbol) {
        return new NumberWithUnitSymbol(Math.floor(arg.value), arg.unit);
      }
      if (!(arg instanceof NumberSymbol))
        throw new InterpreterError("FN_EXPECTS_TYPE_ARGUMENT" /* EXPECTS_TYPE_ARGUMENT */, {
    ...
    this.registerFunction("ceil", (arg) => {
      if (arg instanceof NumberWithUnitSymbol) {
        return new NumberWithUnitSymbol(Math.ceil(arg.value), arg.unit);
      }
      if (!(arg instanceof NumberSymbol))
        throw new InterpreterError("FN_EXPECTS_TYPE_ARGUMENT" /* EXPECTS_TYPE_ARGUMENT */, {
...
//# sourceMappingURL=chunk-4DUQBXYY.js.map
//# sourceMappingURL=chunk-4DUQBXYY.js.map