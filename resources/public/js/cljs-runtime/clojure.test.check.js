...
import "./clojure.test.check.results.js";
import "./clojure.test.check.rose_tree.js";
import "./clojure.test.check.impl.js";
...
var vec__36444 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36444,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36444,(1),null);
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__36454){
var map__36455 = p__36454;
var map__36455__$1 = cljs.core.__destructure_map(map__36455);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36455__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__36455__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__36455__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__36456 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36456,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36456,(1),null);
...
var size = first__36469;
var rest_size_seq = seq__36468__$1;
var vec__36470 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36470,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36470,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq36449){
...
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36450,G__36451,seq36449__$2);
}));
...
var map__36474 = smallest;
var map__36474__$1 = cljs.core.__destructure_map(map__36474);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36474__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__36513 = tail;
var G__36514 = current_smallest;
var G__36515 = (total_nodes_visited + (1));
var G__36516 = depth;
nodes = G__36513;
current_smallest = G__36514;
total_nodes_visited = G__36515;
depth = G__36516;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__36476_36517 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__36476_36517) : reporter_fn.call(null,G__36476_36517));

var temp__5823__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5823__auto__){
var children = temp__5823__auto__;
var G__36518 = children;
var G__36519 = new_smallest;
var G__36520 = (total_nodes_visited + (1));
var G__36521 = (depth + (1));
nodes = G__36518;
current_smallest = G__36519;
total_nodes_visited = G__36520;
depth = G__36521;
continue;
} else {
var G__36522 = tail;
var G__36523 = new_smallest;
var G__36524 = (total_nodes_visited + (1));
var G__36525 = depth;
nodes = G__36522;
current_smallest = G__36523;
total_nodes_visited = G__36524;
depth = G__36525;
continue;
}
}
...
var G__36478_36526 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__36478_36526) : reporter_fn.call(null,G__36478_36526));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__36477_SHARP_){
var G__36482 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__36477_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__36482) : reporter_fn.call(null,G__36482));
}));
var G__36484_36527 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__36484_36527) : reporter_fn.call(null,G__36484_36527));
