 ...
 */
garden.units.convert = (function garden$units$convert(p__81443,right){
var map__81445 = p__81443;
var map__81445__$1 = cljs.core.__destructure_map(map__81445);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81445__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81445__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
 ...
 */
garden.units.unit_re = /([+-]?\d+(?:\.?\d+)?)(p[xtc]|in|[cm]m|%|r?em|ex|ch|v(?:[wh]|m(?:in|ax))|fr|deg|g?rad|turn|m?s|k?Hz|dp(?:i|cm|px))/;
/**
...
var vec__81450 = temp__5825__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81450,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81450,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81450,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81466__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__81467 = u(y);
var map__81467__$1 = cljs.core.__destructure_map(map__81467);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81467__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__81547__delegate = function (x,y,more){
...
var G__81547 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__81548__i = 0, G__81548__a = new Array(arguments.length -  2);
while (G__81548__i < G__81548__a.length) {G__81548__a[G__81548__i] = arguments[G__81548__i + 2]; ++G__81548__i;}
  more = new cljs.core.IndexedSeq(G__81548__a,0,null);
} 
return G__81547__delegate.call(this,x,y,more);};
G__81547.cljs$lang$maxFixedArity = 2;
G__81547.cljs$lang$applyTo = (function (arglist__81549){
var x = cljs.core.first(arglist__81549);
arglist__81549 = cljs.core.next(arglist__81549);
var y = cljs.core.first(arglist__81549);
var more = cljs.core.rest(arglist__81549);
return G__81547__delegate(x,y,more);
});
G__81547.cljs$core$IFn$_invoke$arity$variadic = G__81547__delegate;
return G__81547;
})()
;
...
var G__81551 = null;
if (arguments.length > 2) {
var G__81552__i = 0, G__81552__a = new Array(arguments.length -  2);
while (G__81552__i < G__81552__a.length) {G__81552__a[G__81552__i] = arguments[G__81552__i + 2]; ++G__81552__i;}
G__81551 = new cljs.core.IndexedSeq(G__81552__a,0,null);
}
return garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__81551);
}
...
var map__81472 = u(x);
var map__81472__$1 = cljs.core.__destructure_map(map__81472);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81472__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__81474 = u(y);
var map__81474__$1 = cljs.core.__destructure_map(map__81474);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81474__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__81554__delegate = function (x,y,more){
...
var G__81554 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__81555__i = 0, G__81555__a = new Array(arguments.length -  2);
while (G__81555__i < G__81555__a.length) {G__81555__a[G__81555__i] = arguments[G__81555__i + 2]; ++G__81555__i;}
  more = new cljs.core.IndexedSeq(G__81555__a,0,null);
} 
return G__81554__delegate.call(this,x,y,more);};
G__81554.cljs$lang$maxFixedArity = 2;
G__81554.cljs$lang$applyTo = (function (arglist__81556){
var x = cljs.core.first(arglist__81556);
arglist__81556 = cljs.core.next(arglist__81556);
var y = cljs.core.first(arglist__81556);
var more = cljs.core.rest(arglist__81556);
return G__81554__delegate(x,y,more);
});
G__81554.cljs$core$IFn$_invoke$arity$variadic = G__81554__delegate;
return G__81554;
})()
;
...
var G__81559 = null;
if (arguments.length > 2) {
var G__81560__i = 0, G__81560__a = new Array(arguments.length -  2);
while (G__81560__i < G__81560__a.length) {G__81560__a[G__81560__i] = arguments[G__81560__i + 2]; ++G__81560__i;}
G__81559 = new cljs.core.IndexedSeq(G__81560__a,0,null);
}
return garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__81559);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81489__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__81490 = u(y);
var map__81490__$1 = cljs.core.__destructure_map(map__81490);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81490__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__81563__delegate = function (x,y,more){
...
var G__81563 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__81564__i = 0, G__81564__a = new Array(arguments.length -  2);
while (G__81564__i < G__81564__a.length) {G__81564__a[G__81564__i] = arguments[G__81564__i + 2]; ++G__81564__i;}
  more = new cljs.core.IndexedSeq(G__81564__a,0,null);
} 
return G__81563__delegate.call(this,x,y,more);};
G__81563.cljs$lang$maxFixedArity = 2;
G__81563.cljs$lang$applyTo = (function (arglist__81565){
var x = cljs.core.first(arglist__81565);
arglist__81565 = cljs.core.next(arglist__81565);
var y = cljs.core.first(arglist__81565);
var more = cljs.core.rest(arglist__81565);
return G__81563__delegate(x,y,more);
});
G__81563.cljs$core$IFn$_invoke$arity$variadic = G__81563__delegate;
return G__81563;
})()
;
...
var G__81566 = null;
if (arguments.length > 2) {
var G__81567__i = 0, G__81567__a = new Array(arguments.length -  2);
while (G__81567__i < G__81567__a.length) {G__81567__a[G__81567__i] = arguments[G__81567__i + 2]; ++G__81567__i;}
G__81566 = new cljs.core.IndexedSeq(G__81567__a,0,null);
}
return garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__81566);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var map__81497 = u(x);
var map__81497__$1 = cljs.core.__destructure_map(map__81497);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81497__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__81498 = u(y);
var map__81498__$1 = cljs.core.__destructure_map(map__81498);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81498__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
var garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__81570__delegate = function (x,y,more){
...
var G__81570 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__81572__i = 0, G__81572__a = new Array(arguments.length -  2);
while (G__81572__i < G__81572__a.length) {G__81572__a[G__81572__i] = arguments[G__81572__i + 2]; ++G__81572__i;}
  more = new cljs.core.IndexedSeq(G__81572__a,0,null);
} 
return G__81570__delegate.call(this,x,y,more);};
G__81570.cljs$lang$maxFixedArity = 2;
G__81570.cljs$lang$applyTo = (function (arglist__81573){
var x = cljs.core.first(arglist__81573);
arglist__81573 = cljs.core.next(arglist__81573);
var y = cljs.core.first(arglist__81573);
var more = cljs.core.rest(arglist__81573);
return G__81570__delegate(x,y,more);
});
G__81570.cljs$core$IFn$_invoke$arity$variadic = G__81570__delegate;
return G__81570;
})()
;
...
var G__81574 = null;
if (arguments.length > 2) {
var G__81575__i = 0, G__81575__a = new Array(arguments.length -  2);
while (G__81575__i < G__81575__a.length) {G__81575__a[G__81575__i] = arguments[G__81575__i + 2]; ++G__81575__i;}
G__81574 = new cljs.core.IndexedSeq(G__81575__a,0,null);
}
return garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__81574);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
garden.units.fr = garden.units.make_unit_fn(new cljs.core.Keyword(null,"fr","fr",1577713888));

garden.units.fr_QMARK_ = garden.units.make_unit_predicate(new cljs.core.Keyword(null,"fr","fr",1577713888));

garden.units.fr_PLUS_ = garden.units.make_unit_adder(new cljs.core.Keyword(null,"fr","fr",1577713888));

garden.units.fr_ = garden.units.make_unit_subtractor(new cljs.core.Keyword(null,"fr","fr",1577713888));

garden.units.fr_STAR_ = garden.units.make_unit_multiplier(new cljs.core.Keyword(null,"fr","fr",1577713888));

garden.units.fr_div = garden.units.make_unit_divider(new cljs.core.Keyword(null,"fr","fr",1577713888));
