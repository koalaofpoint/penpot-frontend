...
(instaparse.line_col.Cursor.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5325__auto__,k76595,else__5326__auto__){
var self__ = this;
var this__5325__auto____$1 = this;
var G__76633 = k76595;
var G__76633__$1 = (((G__76633 instanceof cljs.core.Keyword))?G__76633.fqn:null);
switch (G__76633__$1) {
case "index":
return self__.index;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k76595,else__5326__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5346__auto__,p__76661){
var vec__76671 = p__76661;
var k__5347__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76671,(0),null);
var v__5348__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76671,(1),null);
...
return (-1036355234 ^ cljs.core.hash_unordered_coll(coll__5320__auto__));
...
(instaparse.line_col.Cursor.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this76596,other76597){
var self__ = this;
var this76596__$1 = this;
return (((!((other76597 == null)))) && ((((this76596__$1.constructor === other76597.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this76596__$1.index,other76597.index)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this76596__$1.line,other76597.line)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this76596__$1.column,other76597.column)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this76596__$1.__extmap,other76597.__extmap)))))))))));
}));

(instaparse.line_col.Cursor.prototype.cljs$core$IMap$_dissoc$arity$2 = (function (this__5333__auto__,k__5334__auto__){
var self__ = this;
var this__5333__auto____$1 = this;
if(cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"index","index",-1531685915),null,new cljs.core.Keyword(null,"column","column",2078222095),null,new cljs.core.Keyword(null,"line","line",212345235),null], null), null),k__5334__auto__)){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core._with_meta(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,this__5333__auto____$1),self__.__meta),k__5334__auto__);
} else {
return (new instaparse.line_col.Cursor(self__.index,self__.line,self__.column,self__.__meta,cljs.core.not_empty(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(self__.__extmap,k__5334__auto__)),null));
}
}));

(instaparse.line_col.Cursor.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5330__auto__,k76595){
var self__ = this;
var this__5330__auto____$1 = this;
var G__76755 = k76595;
var G__76755__$1 = (((G__76755 instanceof cljs.core.Keyword))?G__76755.fqn:null);
switch (G__76755__$1) {
case "index":
case "line":
case "column":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k76595);

}
}));

(instaparse.line_col.Cursor.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5331__auto__,k__5332__auto__,G__76594){
var self__ = this;
var this__5331__auto____$1 = this;
var pred__76757 = cljs.core.keyword_identical_QMARK_;
var expr__76758 = k__5332__auto__;
if(cljs.core.truth_((pred__76757.cljs$core$IFn$_invoke$arity$2 ? pred__76757.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"index","index",-1531685915),expr__76758) : pred__76757.call(null,new cljs.core.Keyword(null,"index","index",-1531685915),expr__76758)))){
return (new instaparse.line_col.Cursor(G__76594,self__.line,self__.column,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__76757.cljs$core$IFn$_invoke$arity$2 ? pred__76757.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"line","line",212345235),expr__76758) : pred__76757.call(null,new cljs.core.Keyword(null,"line","line",212345235),expr__76758)))){
return (new instaparse.line_col.Cursor(self__.index,G__76594,self__.column,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__76757.cljs$core$IFn$_invoke$arity$2 ? pred__76757.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"column","column",2078222095),expr__76758) : pred__76757.call(null,new cljs.core.Keyword(null,"column","column",2078222095),expr__76758)))){
return (new instaparse.line_col.Cursor(self__.index,self__.line,G__76594,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.line_col.Cursor(self__.index,self__.line,self__.column,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5332__auto__,G__76594),null));
}
}
}
}));
...
(instaparse.line_col.Cursor.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5322__auto__,G__76594){
var self__ = this;
var this__5322__auto____$1 = this;
return (new instaparse.line_col.Cursor(self__.index,self__.line,self__.column,G__76594,self__.__extmap,self__.__hash));
}));
...
return cljs.core._write(writer__5370__auto__,"instaparse.line-col/Cursor");
}));
 ...
 */
instaparse.line_col.map__GT_Cursor = (function instaparse$line_col$map__GT_Cursor(G__76605){
var extmap__5365__auto__ = (function (){var G__76765 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__76605,new cljs.core.Keyword(null,"index","index",-1531685915),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"column","column",2078222095)], 0));
if(cljs.core.record_QMARK_(G__76605)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__76765);
} else {
return G__76765;
}
})();
return (new instaparse.line_col.Cursor(new cljs.core.Keyword(null,"index","index",-1531685915).cljs$core$IFn$_invoke$arity$1(G__76605),new cljs.core.Keyword(null,"line","line",212345235).cljs$core$IFn$_invoke$arity$1(G__76605),new cljs.core.Keyword(null,"column","column",2078222095).cljs$core$IFn$_invoke$arity$1(G__76605),null,cljs.core.not_empty(extmap__5365__auto__),null));
});
...
var G__76838 = (index + (1));
var G__76839 = line;
var G__76840 = (column + (1));
index = G__76838;
line = G__76839;
column = G__76840;
continue;
...
var cursor_state = cljs.core.atom.cljs$core$IFn$_invoke$arity$1((new instaparse.line_col.Cursor((0),start_line,start_column,null,null,null)));
...
var line_col_fn = instaparse.line_col.make_line_col_fn(text,start_line,start_column);
if((parse_tree == null)){
return null;
} else {
...
if(cljs.core.truth_((function (){var and__5023__auto__ = cljs.core.sequential_QMARK_(parse_tree);
if(and__5023__auto__){
var and__5023__auto____$1 = cljs.core.map_QMARK_(cljs.core.first(parse_tree));
