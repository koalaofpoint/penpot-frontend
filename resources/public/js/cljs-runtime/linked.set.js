...
var self__ = this;
var coll__$1 = this;
var temp__5825__auto__ = cljs.core.rseq(self__.linked_map);
...
var self__ = this;
var coll__$1 = this;
return ((cljs.core.set_QMARK_(other)) && ((((cljs.core.count(coll__$1) === cljs.core.count(other))) && (cljs.core.every_QMARK_((function (p1__29019_SHARP_){
return cljs.core.contains_QMARK_(coll__$1,p1__29019_SHARP_);
}),other)))));
}));
...
var self__ = this;
var coll__$1 = this;
var temp__5825__auto__ = cljs.core.seq(self__.linked_map);
if(temp__5825__auto__){
var s = temp__5825__auto__;
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.key,s);
} else {
...
(linked.set.LinkedSet.prototype.call = (function (unused__14253__auto__){
var self__ = this;
var self__ = this;
var G__29049 = (arguments.length - (1));
switch (G__29049) {
case (1):
...
(linked.set.LinkedSet.prototype.apply = (function (self__,args29024){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args29024)));
}));
...
(linked.set.LinkedSet.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"linked.set/LinkedSet");
}));
