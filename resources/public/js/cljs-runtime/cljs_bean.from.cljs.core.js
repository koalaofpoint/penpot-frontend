...
var G__42930 = cljs.core.next(xs);
var G__42931 = cljs.core.next(ys);
xs = G__42930;
ys = G__42931;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__42870 = val;
var G__42871 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__42870,G__42871) : f.call(null,G__42870,G__42871));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__42874 = val__$1;
var G__42875 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
...
while(true){
if((n < cnt)){
var nval = (function (){var G__42876 = val__$1;
var G__42877 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__42876,G__42877) : f.call(null,G__42876,G__42877));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__42944 = cljs.core.next(es);
var G__42945 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__42944;
tcoll__$1 = G__42945;
continue;
} else {
...
var G__42946 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__42947 = cljs.core.next(es);
ret = G__42946;
es = G__42947;
continue;
} else {
