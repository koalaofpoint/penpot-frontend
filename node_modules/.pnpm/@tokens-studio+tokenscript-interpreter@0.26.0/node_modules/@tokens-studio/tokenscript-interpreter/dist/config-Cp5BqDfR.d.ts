...
type Specs$1 = Map<uriType$1, ColorSpecification>;
...
declare class ColorManager extends BaseManager<ColorSpecification, ColorSymbol, ColorSymbol> {
     ...
     */
    clone(): this;
    registerRootInitializers(_uri: uriType$1, spec: ColorSpecification): void;
    registerConversions(uri: uriType$1, spec: ColorSpecification): void;
    register(uri: uriType$1, spec: ColorSpecification | string): ColorSpecification;
