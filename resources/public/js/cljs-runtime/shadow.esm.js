...
throw (new Error(["could not find loadable info for: ",s].join('')));
}

var module__$1 = (info["module"]);
var accessor = (info["get"]);
return shadow.esm.dynamic_import(["./",cljs.core.str.cljs$core$IFn$_invoke$arity$1(module__$1),".js"].join('')).then((function (module__$2){
