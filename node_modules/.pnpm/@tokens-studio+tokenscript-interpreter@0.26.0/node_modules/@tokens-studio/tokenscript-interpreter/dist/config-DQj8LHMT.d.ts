...
declare class IdentifierNode implements ASTNode {
    token: Token;
    nodeType: string;
    name: string;
    constructor(token: Token);
}
declare class ReassignNode implements ASTNode {
    identifier: IdentifierNode | IdentifierNode[];
    value: ASTNode;
    token?: Token | undefined;
    nodeType: string;
    constructor(identifier: IdentifierNode | IdentifierNode[], value: ASTNode, token?: Token | undefined);
...
declare abstract class BaseSymbolType implements ISymbolType {
...
declare class NumberSymbol extends BaseSymbolType {
    type: string;
    static readonly type = "Number";
    static _SUPPORTED_METHODS: {
        to_string: {
            name: string;
            function: (this: NumberSymbol, radix?: NumberSymbol) => StringSymbol;
            args: {
                name: string;
                type: string;
                optional: boolean;
...
declare class StringSymbol extends BaseSymbolType {
    type: string;
    ...
    static _SUPPORTED_METHODS: {
        ...
        length: {
            function: (this: StringSymbol) => NumberSymbol;
            args: never[];
            returnType: string;
        };
        concat: {
            function: (this: StringSymbol, other: StringSymbol) => StringSymbol;
            args: {
                name: string;
                type: string;
            }[];
        ...
        split: {
            function: (this: StringSymbol, delimiter?: StringSymbol) => ListSymbol;
            args: {
                name: string;
                type: string;
                optional: boolean;
...
declare class ListSymbol extends BaseSymbolType {
    type: string;
    static readonly type = "List";
    static _SUPPORTED_METHODS: {
        append: {
            function: (this: ListSymbol, item: ISymbolType) => ListSymbol;
            args: {
                name: string;
                type: string;
            }[];
        ...
        extend: {
            function: (this: ListSymbol, ...items: ISymbolType[]) => ListSymbol;
            args: never[];
            returnType: string;
        };
        insert: {
            function: (this: ListSymbol, index: NumberSymbol, item: ISymbolType) => ListSymbol;
            args: {
                name: string;
                type: string;
            }[];
        ...
        delete: {
            function: (this: ListSymbol, index: NumberSymbol) => ListSymbol;
            args: {
                name: string;
                type: string;
            }[];
        ...
        length: {
            function: (this: ListSymbol) => NumberSymbol;
            args: never[];
            returnType: string;
        };
        index: {
            function: (this: ListSymbol, item: ISymbolType) => NumberSymbol;
            args: {
                name: string;
                type: string;
            }[];
        ...
        get: {
            function: (this: ListSymbol, index: NumberSymbol) => ISymbolType;
            args: {
                name: string;
                type: string;
            }[];
        ...
        join: {
            function: (this: ListSymbol, separator?: StringSymbol) => StringSymbol;
            args: {
                name: string;
                type: string;
                optional: boolean;
    ...
    value: ISymbolType[];
    isImplicit: boolean;
    constructor(elements: ISymbolType[] | null, isImplicit?: boolean, config?: Config);
    validValue(val: any): boolean;
    toString(): string;
...
declare class NumberWithUnitSymbol extends BaseSymbolType {
    type: string;
    static readonly type = "NumberWithUnit";
    static _SUPPORTED_METHODS: {
        to_string: {
            name: string;
            function: (this: NumberWithUnitSymbol) => StringSymbol;
            args: {
                name: string;
                type: string;
                optional: boolean;
        ...
        to_number: {
            function: (this: NumberWithUnitSymbol) => NumberSymbol;
            args: never[];
            returnType: string;
        };
    };
    value: NumberWithUnitValue;
    unit: SupportedFormats;
    constructor(value: number | NumberSymbol | null, unit: SupportedFormats | string, config?: Config);
    validValue(val: any): boolean;
    static fromRecord(record: {
        value: number | string;
        unit: string;
        type?: string;
    }, config?: Config): NumberWithUnitSymbol | undefined;
    toString(): string;
    expectSafeValue(val: any): asserts val is number;
    ...
    getAttribute(attributeName: string): ISymbolType | null;
    getTypeName(): string;
    toJs(options?: ToJsOptions): string | {
        value: number | null;
        unit: string;
    };
}
type TokenValue = Map<string, ISymbolType> | ISymbolType[];
declare class TokenSymbol extends BaseSymbolType {
    type: string;
    static readonly type = "Token";
    static _SUPPORTED_METHODS: {
        get: {
            function: (this: TokenSymbol, keyOrIndex: StringSymbol | NumberSymbol) => ISymbolType;
            args: {
                name: string;
                type: string;
                optional: boolean;
        ...
        set: {
            function: (this: TokenSymbol, key: StringSymbol, value: ISymbolType) => TokenSymbol;
            args: {
                name: string;
                type: string;
                optional: boolean;
        ...
        keys: {
            function: (this: TokenSymbol) => ListSymbol;
            args: never[];
            returnType: string;
        };
        values: {
        ...
        length: {
            function: (this: TokenSymbol) => NumberSymbol;
            args: never[];
            returnType: string;
        };
        append: {
            function: (this: TokenSymbol, item: ISymbolType) => TokenSymbol;
            args: {
                name: string;
                type: string;
            }[];
        ...
        extend: {
            function: (this: TokenSymbol, ...items: ISymbolType[]) => TokenSymbol;
            args: never[];
            returnType: string;
        };
        insert: {
            function: (this: TokenSymbol, index: NumberSymbol, item: ISymbolType) => TokenSymbol;
            args: {
                name: string;
                type: string;
            }[];
        ...
        delete: {
            function: (this: TokenSymbol, index: NumberSymbol) => TokenSymbol;
            args: {
                name: string;
                type: string;
            }[];
        ...
        index: {
            function: (this: TokenSymbol, item: ISymbolType) => NumberSymbol;
            args: {
                name: string;
                type: string;
            }[];
        ...
        join: {
            function: (this: TokenSymbol, separator?: StringSymbol) => StringSymbol;
            args: {
                name: string;
                type: string;
                optional: boolean;
     ...
     */
    metadata?: SymbolMetadata;
    constructor(subType: string, value: TokenValue | Record<string, ISymbolType> | TokenSymbol | null, config?: Config, metadata?: SymbolMetadata);
    validValue(val: any): boolean;
    toString(): string;
...
declare class ColorSymbol extends BaseSymbolType {
    type: string;
    static readonly type = "Color";
    static _SUPPORTED_METHODS: {
        to_string: {
            name: string;
            function: (this: ColorSymbol) => StringSymbol;
            args: never[];
            returnType: string;
        };
    };
 ...
 */
type JsValue = string | number | boolean | null | JsValue[] | {
    [key: string]: JsValue;
};
 ...
 */
declare abstract class BaseManager<TSpec, TInput, TOutput> {
    protected specs: Map<uri, TSpec>;
    protected specTypes: Map<uri, specType>;
    protected conversions: Map<uri, Map<uri, (input: TInput) => TOutput>>;
     ...
     */
    hasConversion(sourceUri: uri, targetUri: uri): boolean;
    /**
     * Get a specification by its URI with version resolution
     */
    getSpec(uri: uri): TSpec | undefined;
    /**
     ...
     */
    protected registerConversionFunction(sourceUri: uri, targetUri: uri, conversionFn: (input: TInput) => TOutput): void;
    abstract register(uri: uri, spec: TSpec | specType): TSpec;
     ...
     */
    getParentConfig(): Config | undefined;
    /**
...
interface SpecProperty$1 {
    type: "number" | "string" | "color";
}
interface SpecSchemaType$1 {
    type: "object";
    properties: Record<string, SpecProperty$1>;
    required?: string[];
    order?: string[];
...
type uriType$2 = string;
type Specs$1 = Map<uriType$2, ColorSpecification>;
interface FormatColorOptions {
    decimalPlaces?: number;
    removeTrailingZeros?: boolean;
}
declare class ColorManager extends BaseManager<ColorSpecification, ColorSymbol, ColorSymbol> {
    private initializers;
    constructor(defaultSpecs?: Specs$1);
     ...
     */
    clone(): this;
    registerRootInitializers(_uri: uriType$2, spec: ColorSpecification): void;
    registerConversions(uri: uriType$2, spec: ColorSpecification): void;
    register(uri: uriType$2, spec: ColorSpecification | string): ColorSpecification;
    getSpecByType(type: string): ColorSpecification | undefined;
    getSpecFromColor(color: ColorSymbol): ColorSpecification | undefined;
    hasInitializer(keyword: string): boolean;
    executeInitializer(keyword: string, args: Array<ISymbolType>): ColorSymbol;
    hasConversionByType(sourceType: string, targetType: string): boolean;
    convertTo(color: ColorSymbol, targetUri: string): ColorSymbol;
    convertToByType(color: ColorSymbol, targetType: string): ColorSymbol;
...
declare class FunctionsManager extends BaseManager<FunctionSpecification, ISymbolType[], ISymbolType> {
    private functionMap;
    constructor();
    protected getSpecName(spec: FunctionSpecification): string;
    clone(): this;
    register(name: functionName, spec: FunctionSpecification | string): FunctionSpecification;
    private setupBuiltinFunctions;
    private registerFunction;
    private registerDynamicFunction;
    getFunction(name: string): FunctionImpl | undefined;
...
declare class TokenManager extends BaseManager<TokenSpecification, TokenSymbol, TokenSymbol> {
    /**
     ...
     */
    registerValidation(tokenType: string, validation: string | {
        type: string;
        script: string;
    }): void;
    /**
     ...
     */
    getValidation(tokenType: string): string | undefined;
    /**
     ...
     */
    validate(tokenType: string, value: ISymbolType, visitedUrls?: Set<string>, basePath?: (string | number)[], depth?: number): ValidationResult[];
    /**
...
declare class UnitManager extends BaseManager<UnitSpecification, NumberWithUnitSymbol, NumberWithUnitSymbol> {
    private unitKeywords;
    constructor(defaultSpecs?: Specs);
     ...
     */
    clone(): this;
    registerConversions(uri: uriType, spec: UnitSpecification): void;
    register(uri: uriType, spec: UnitSpecification | string): UnitSpecification;
    getSpecByKeyword(keyword: unitKey): UnitSpecification | undefined;
    getUriByKeyword(keyword: unitKey): string | undefined;
    convertTo(unit: NumberWithUnitSymbol, targetUri: uriType): NumberWithUnitSymbol;
    private isOneNumberRelative;
    private convertRelative;
    convertToCommonFormat(inputs: Array<NumberSymbol | NumberWithUnitSymbol>): Array<NumberSymbol | NumberWithUnitSymbol>;
}
...
declare class Config {
    ...
    clone(): Config;
    registerSchemas(schemas: Array<{
        uri: string;
        schema: ColorSpecification | FunctionSpecification | TokenSpecification;
    }>): Config;
}

export { type ASTNode as A, Config as C, type ISymbolType as I, Operations as O, type ReferenceRecord as R, type SymbolMetadata as S, type Token as T, UNINTERPRETED_KEYWORDS as U, SupportedFormats as a, ReservedKeyword as b, TokenType as c, type ReferenceRecordValue as d };
