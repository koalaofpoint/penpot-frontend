...
var G__75539 = new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f);
var G__75539__$1 = (((G__75539 instanceof cljs.core.Keyword))?G__75539.fqn:null);
switch (G__75539__$1) {
case "raw":
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5503__auto__ = (function instaparse$reduction$iter__75542(s__75543){
return (new cljs.core.LazySeq(null,(function (){
var s__75543__$1 = s__75543;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__75543__$1);
if(temp__5825__auto__){
var s__75543__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__75543__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__75543__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__75545 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__75544 = (0);
while(true){
if((i__75544 < size__5502__auto__)){
var vec__75546 = cljs.core._nth(c__5501__auto__,i__75544);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75546,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75546,(1),null);
cljs.core.chunk_append(b__75545,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)));

var G__75554 = (i__75544 + (1));
i__75544 = G__75554;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__75545),instaparse$reduction$iter__75542(cljs.core.chunk_rest(s__75543__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__75545),null);
}
} else {
var vec__75549 = cljs.core.first(s__75543__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75549,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75549,(1),null);
return cljs.core.cons((cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)),instaparse$reduction$iter__75542(cljs.core.rest(s__75543__$2)));
}
} else {
return null;
}
