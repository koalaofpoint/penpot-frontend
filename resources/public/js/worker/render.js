var WasmModule = (() => {
  ...
  var render_wasm_exports = {};
  __export(render_wasm_exports, {
    default: () => render_wasm_default
  });
  const import_meta = {};
  var createRustSkiaModule = /* @__PURE__ */ (() => {
    return (async function(moduleArg = {}) {
      ...
      var _emscripten_resize_heap = (requestedSize) => {
        ...
        for (var cutDown = 1; cutDown <= 4; cutDown *= 2) {
          var overGrownHeapSize = oldSize * (1 + 0.8 / cutDown);
      ...
      function _wapi_cancelAnimationFrame(frameId) {
      ...
      function _wapi_requestAnimationFrame() {
        if (typeof WorkerGlobalScope !== "undefined" && self instanceof WorkerGlobalScope) {
      ...
      var _text_editor_export_selection = Module["_text_editor_export_selection"] = createExportWrapper("text_editor_export_selection", 0);
      var _text_editor_extend_selection_to_point = Module["_text_editor_extend_selection_to_point"] = createExportWrapper("text_editor_extend_selection_to_point", 2);
      var _text_editor_get_active_shape_id = Module["_text_editor_get_active_shape_id"] = createExportWrapper("text_editor_get_active_shape_id", 1);
      var _text_editor_get_cursor_rect = Module["_text_editor_get_cursor_rect"] = createExportWrapper("text_editor_get_cursor_rect", 0);
      var _text_editor_get_selection = Module["_text_editor_get_selection"] = createExportWrapper("text_editor_get_selection", 1);
      var _text_editor_get_selection_rects = Module["_text_editor_get_selection_rects"] = createExportWrapper("text_editor_get_selection_rects", 0);
      var _text_editor_insert_paragraph = Module["_text_editor_insert_paragraph"] = createExportWrapper("text_editor_insert_paragraph", 0);
      var _text_editor_insert_text = Module["_text_editor_insert_text"] = createExportWrapper("text_editor_insert_text", 0);
      var _text_editor_is_active = Module["_text_editor_is_active"] = createExportWrapper("text_editor_is_active", 0);
      var _text_editor_move_cursor = Module["_text_editor_move_cursor"] = createExportWrapper("text_editor_move_cursor", 2);
      var _text_editor_poll_event = Module["_text_editor_poll_event"] = createExportWrapper("text_editor_poll_event", 0);
      var _text_editor_render_overlay = Module["_text_editor_render_overlay"] = createExportWrapper("text_editor_render_overlay", 0);
      var _text_editor_select_all = Module["_text_editor_select_all"] = createExportWrapper("text_editor_select_all", 0);
      var _text_editor_set_cursor_from_point = Module["_text_editor_set_cursor_from_point"] = createExportWrapper("text_editor_set_cursor_from_point", 2);
  ...
  var render_wasm_default = createRustSkiaModule;
  return __toCommonJS(render_wasm_exports);
})();
