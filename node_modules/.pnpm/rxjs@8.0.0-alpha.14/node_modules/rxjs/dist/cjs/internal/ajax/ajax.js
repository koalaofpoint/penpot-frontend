...
const AjaxResponse_js_1 = require("./AjaxResponse.js");
...
const mapResponse = (0, map_js_1.map)((x) => x.response);
...
function fromAjax(init) {
    return new Observable_js_1.Observable((destination) => {
        ...
        const xhr = init.createXHR ? init.createXHR() : new XMLHttpRequest();
        {
            ...
            addErrorEvent('timeout', () => new errors_js_1.AjaxTimeoutError(xhr, _request));
            addErrorEvent('abort', () => new errors_js_1.AjaxError('aborted', xhr, _request));
            const createResponse = (direction, event) => new AjaxResponse_js_1.AjaxResponse(event, xhr, _request, `${direction}_${event.type}`);
            ...
            const emitError = (status) => {
                ...
                destination.error(new errors_js_1.AjaxError(msg, xhr, _request));
            };
