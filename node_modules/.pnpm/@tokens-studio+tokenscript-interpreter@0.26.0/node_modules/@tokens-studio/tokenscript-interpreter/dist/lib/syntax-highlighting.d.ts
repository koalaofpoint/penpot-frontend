...
import { R as ReservedKeyword, u as SupportedFormats, O as Operations } from './types-DSZPf9oj.js';
import 'arktype/internal/variants/object.ts';

declare const tokenscriptLanguageDefinition: languages.IMonarchLanguage;
declare const tokenscriptLanguageConfig: languages.LanguageConfiguration;

/**
 * Prism.js syntax highlighting for TokenScript
 * Uses shared patterns from spec.ts
 */
declare function tokenscriptLanguage(Prism: any): any;
...
declare const KEYWORDS: ReservedKeyword[];
declare const TYPES: readonly ["String", "Number", "NumberWithUnit", "Color", "List", "Dictionary", "Boolean"];
declare const BUILTIN_FUNCTIONS: readonly ["rgb", "hsl", "srgb", "lrgb", "hex", "oklch", "oklchRamp", "lighten", "darken", "saturate", "desaturate", "spin", "mix", "round_to", "snap", "remap", "pow", "linear-gradient", "type"];
declare const UNITS: SupportedFormats[];
declare const OPERATORS: readonly [...Operations[], "=", ">", "<", ":", "==", "<=", ">=", "!="];
declare const PATTERNS: {
    ...
    readonly numberWithUnit: RegExp;
 ...
 */
declare const MONACO_PATTERNS: {
    /** Invalid string (unterminated double quote) - Monaco-specific for error highlighting */
    readonly stringInvalidDouble: RegExp;
    /** Invalid string (unterminated single quote) - Monaco-specific for error highlighting */
    readonly stringInvalidSingle: RegExp;
    /** String start (double quote) - Monaco-specific for state-based tokenization */
    readonly stringStartDouble: RegExp;
    /** String start (single quote) - Monaco-specific for state-based tokenization */
    readonly stringStartSingle: RegExp;
    /** Number with any unit (captures unit for dynamic validation) - Monaco-specific for unit validation */
    readonly numberWithDynamicUnit: RegExp;
};
declare function createKeywordPattern(keywords: readonly string[]): RegExp;
declare function createUnitPattern(units: readonly string[]): RegExp;

export { BUILTIN_FUNCTIONS, KEYWORDS, MONACO_PATTERNS, OPERATORS, PATTERNS, TYPES, UNITS, createKeywordPattern, createUnitPattern, tokenscriptLanguage, tokenscriptLanguageConfig, tokenscriptLanguageDefinition };
