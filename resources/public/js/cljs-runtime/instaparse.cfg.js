...
var G__76540 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__76540)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__76540)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__76540)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__76540)].join('')));
...
while(true){
var temp__5823__auto__ = cljs.core.first(sq);
if(cljs.core.truth_(temp__5823__auto__)){
var c = temp__5823__auto__;
var G__76582 = c;
switch (G__76582) {
case "\\":
var temp__5823__auto____$1 = cljs.core.second(sq);
if(cljs.core.truth_(temp__5823__auto____$1)){
var c2 = temp__5823__auto____$1;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(c2,"'")){
var G__76775 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__76776 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__76775;
v = G__76776;
continue;
} else {
var G__76777 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__76778 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__76777;
v = G__76778;
continue;
}
...
break;
case "\"":
var G__76779 = cljs.core.next(sq);
var G__76780 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__76779;
v = G__76780;
continue;
...
break;
default:
var G__76781 = cljs.core.next(sq);
var G__76782 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__76781;
v = G__76782;
continue;
...
var read_string_STAR__76783 = cljs.core.deref(new cljs.core.Var(function(){return cljs.tools.reader.read_string_STAR_;},new cljs.core.Symbol("cljs.tools.reader","read-string*","cljs.tools.reader/read-string*",1492661621,null),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"private","private",-558947994),new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"file","file",-1269645878),new cljs.core.Keyword(null,"end-column","end-column",1425389514),new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"end-line","end-line",1837326455),new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"test","test",577538877)],[true,new cljs.core.Symbol(null,"cljs.tools.reader","cljs.tools.reader",-831293977,null),new cljs.core.Symbol(null,"read-string*","read-string*",1046768315,null),"cljs/tools/reader.cljs",20,1,306,306,cljs.core.list(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.with_meta(new cljs.core.Symbol(null,"reader","reader",1810192380,null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Symbol(null,"not-native","not-native",-236392494,null)], null)),new cljs.core.Symbol(null,"_","_",-1201019570,null),new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"pending-forms","pending-forms",-1225172071,null)], null)),null,(cljs.core.truth_(cljs.tools.reader.read_string_STAR_)?cljs.tools.reader.read_string_STAR_.cljs$lang$test:null)])));
instaparse.cfg.safe_read_string = (function instaparse$cfg$safe_read_string(s){
var G__76590 = cljs.tools.reader.reader_types.string_push_back_reader.cljs$core$IFn$_invoke$arity$1(s);
var G__76591 = null;
var G__76592 = null;
var G__76593 = null;
return (read_string_STAR__76783.cljs$core$IFn$_invoke$arity$4 ? read_string_STAR__76783.cljs$core$IFn$_invoke$arity$4(G__76590,G__76591,G__76592,G__76593) : read_string_STAR__76783.call(null,G__76590,G__76591,G__76592,G__76593));
});
/**
...
while(true){
var G__76609 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__76609__$1 = (((G__76609 instanceof cljs.core.Keyword))?G__76609.fqn:null);
switch (G__76609__$1) {
case "rule":
var vec__76613 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76613,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76613,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__76616 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__76616) : instaparse.cfg.content.call(null,G__76616));
...
break;
case "paren":
var G__76789 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__76789;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__76620 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__76620) : instaparse.cfg.build_rule.call(null,G__76620));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__76621 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__76621) : instaparse.cfg.build_rule.call(null,G__76621));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__76622 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__76622) : instaparse.cfg.build_rule.call(null,G__76622));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__76623 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__76623) : instaparse.cfg.build_rule.call(null,G__76623));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__76624 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__76624) : instaparse.cfg.build_rule.call(null,G__76624));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__76625 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__76625) : instaparse.cfg.build_rule.call(null,G__76625));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__76609__$1)].join('')));
...
while(true){
var G__76628 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
var G__76628__$1 = (((G__76628 instanceof cljs.core.Keyword))?G__76628.fqn:null);
switch (G__76628__$1) {
case "nt":
...
case "neg":
case "rep":
var G__76796 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__76796;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__76628__$1)].join('')));
...
var valid_nts_76798 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__76629_76799 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__76630_76800 = null;
var count__76631_76801 = (0);
var i__76632_76802 = (0);
while(true){
if((i__76632_76802 < count__76631_76801)){
var nt_76803 = chunk__76630_76800.cljs$core$IIndexed$_nth$arity$2(null,i__76632_76802);
if(cljs.core.truth_((valid_nts_76798.cljs$core$IFn$_invoke$arity$1 ? valid_nts_76798.cljs$core$IFn$_invoke$arity$1(nt_76803) : valid_nts_76798.call(null,nt_76803)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_76803),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__76804 = seq__76629_76799;
var G__76805 = chunk__76630_76800;
var G__76806 = count__76631_76801;
var G__76807 = (i__76632_76802 + (1));
seq__76629_76799 = G__76804;
chunk__76630_76800 = G__76805;
count__76631_76801 = G__76806;
i__76632_76802 = G__76807;
continue;
} else {
var temp__5825__auto___76808 = cljs.core.seq(seq__76629_76799);
if(temp__5825__auto___76808){
var seq__76629_76809__$1 = temp__5825__auto___76808;
if(cljs.core.chunked_seq_QMARK_(seq__76629_76809__$1)){
var c__5548__auto___76810 = cljs.core.chunk_first(seq__76629_76809__$1);
var G__76811 = cljs.core.chunk_rest(seq__76629_76809__$1);
var G__76812 = c__5548__auto___76810;
var G__76813 = cljs.core.count(c__5548__auto___76810);
var G__76814 = (0);
seq__76629_76799 = G__76811;
chunk__76630_76800 = G__76812;
count__76631_76801 = G__76813;
i__76632_76802 = G__76814;
continue;
} else {
var nt_76816 = cljs.core.first(seq__76629_76809__$1);
if(cljs.core.truth_((valid_nts_76798.cljs$core$IFn$_invoke$arity$1 ? valid_nts_76798.cljs$core$IFn$_invoke$arity$1(nt_76816) : valid_nts_76798.call(null,nt_76816)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_76816),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__76817 = cljs.core.next(seq__76629_76809__$1);
var G__76818 = null;
var G__76819 = (0);
var G__76820 = (0);
seq__76629_76799 = G__76817;
chunk__76630_76800 = G__76818;
count__76631_76801 = G__76819;
i__76632_76802 = G__76820;
continue;
}
} else {
}
...
instaparse.cfg.build_parser = (function instaparse$cfg$build_parser(var_args){
...
return instaparse.cfg.build_parser.cljs$core$IFn$_invoke$arity$3(spec,output_format,false);
}));

(instaparse.cfg.build_parser.cljs$core$IFn$_invoke$arity$3 = (function (spec,output_format,allow_namespaced_nts_QMARK_){
var rules = instaparse.gll.parse((cljs.core.truth_(allow_namespaced_nts_QMARK_)?instaparse.cfg.cfg_allow_namespaced_nts:instaparse.cfg.cfg),new cljs.core.Keyword(null,"rules","rules",1198912366),spec,false);
...
var _STAR_print_newline_STAR__orig_val__76700_76822 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__76701_76823 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__76702_76824 = true;
var _STAR_print_fn_STAR__temp_val__76703_76825 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__76702_76824);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__76703_76825);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__76701_76823);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__76700_76822);
}
...
var len__5749__auto___76826 = arguments.length;
var i__5750__auto___76827 = (0);
while(true){
if((i__5750__auto___76827 < len__5749__auto___76826)){
args__5755__auto__.push((arguments[i__5750__auto___76827]));

var G__76828 = (i__5750__auto___76827 + (1));
i__5750__auto___76827 = G__76828;
continue;
} else {
}
break;
...
return instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5756__auto__);
});

(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__76744){
var map__76745 = p__76744;
var map__76745__$1 = cljs.core.__destructure_map(map__76745);
var opts = map__76745__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__76749 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__76750 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__76750);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__5670__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__76751_76829 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__76752_76830 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__76753_76831 = true;
var _STAR_print_fn_STAR__temp_val__76754_76832 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__76753_76831);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__76754_76832);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__76752_76830);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__76751_76829);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5670__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__76749);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq76742){
var G__76743 = cljs.core.first(seq76742);
var seq76742__$1 = cljs.core.next(seq76742);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__76743,seq76742__$1);
}));
