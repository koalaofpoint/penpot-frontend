import { __name, SupportedFormats, ReservedKeyword, UNINTERPRETED_KEYWORDS } from './chunk-JL4UU4PY.js';
...
var getMessage = /* @__PURE__ */ __name((code, data) => {
...
__name(isLanguageError, "isLanguageError");
...
var isSome = /* @__PURE__ */ __name((v) => {
  return v != null;
}, "isSome");
var isNone = /* @__PURE__ */ __name((v) => {
  return v == null;
}, "isNone");
var isNull = /* @__PURE__ */ __name((v) => {
  return v === null;
}, "isNull");
var isUndefined = /* @__PURE__ */ __name((v) => {
  return v === void 0;
}, "isUndefined");
var isObject = /* @__PURE__ */ __name((v) => {
  return typeof v === "object" && v !== null && !Array.isArray(v);
}, "isObject");
var isString = /* @__PURE__ */ __name((v) => {
  return typeof v === "string";
}, "isString");
var isNumber = /* @__PURE__ */ __name((v) => {
  return typeof v === "number" && !Number.isNaN(v);
}, "isNumber");
var isBoolean = /* @__PURE__ */ __name((v) => {
  return typeof v === "boolean";
}, "isBoolean");
var isArray = /* @__PURE__ */ __name((v) => {
  return Array.isArray(v);
}, "isArray");
var isMap = /* @__PURE__ */ __name((v) => v instanceof Map, "isMap");
var getKeyAlt = /* @__PURE__ */ __name((keys, record) => {
...
var isObjectWithKey = /* @__PURE__ */ __name((value, key) => {
  return isObject(value) && key in value;
}, "isObjectWithKey");
var ensureArray = /* @__PURE__ */ __name((v) => {
  if (isNone(v)) return [];
  if (isArray(v)) return v;
  return [v];
}, "ensureArray");
var isOutOfBounds = /* @__PURE__ */ __name((value, index) => {
  if (!isArray(value)) return true;
  return index < 0 || index >= value.length;
}, "isOutOfBounds");
var isOutOfBoundsInclusive = /* @__PURE__ */ __name((value, index) => {
  if (!isArray(value)) return true;
  return index < 0 || index > value.length;
}, "isOutOfBoundsInclusive");
var safeParseInt = /* @__PURE__ */ __name((v) => {
...
var nullToUndefined = /* @__PURE__ */ __name((v) => isNull(v) ? void 0 : v, "nullToUndefined");
...
__name(isValidAlpha, "isValidAlpha");
...
__name(ensureValidAlpha, "ensureValidAlpha");
function isTransparent(alpha) {
  return alpha !== null && alpha < 1;
}
__name(isTransparent, "isTransparent");

// src/interpreter/utils/string.ts
var isAlpha = /* @__PURE__ */ __name((char) => {
  if (char === null) return false;
  const cp = char.codePointAt(0) ?? 0;
  return cp >= 65 && cp <= 90 || // A-Z
  cp >= 97 && cp <= 122;
}, "isAlpha");
var isNumber2 = /* @__PURE__ */ __name((char) => {
  if (char === null) return false;
  const cp = char.codePointAt(0) ?? 0;
  return cp >= 48 && cp <= 57;
}, "isNumber");
var isAlphaNumeric = /* @__PURE__ */ __name((char) => {
  if (char === null) return false;
  return isAlpha(char) || isNumber2(char);
}, "isAlphaNumeric");
var isSpace = /* @__PURE__ */ __name((char) => {
  if (char === null) return false;
  return /\s/.test(char);
}, "isSpace");
var capitalize = /* @__PURE__ */ __name((str) => `${str.charAt(0).toUpperCase()}${str.slice(1).toLowerCase()}`, "capitalize");

// src/interpreter/symbols.ts
function isTokenscriptSymbol(value) {
  return isObjectWithKey(value, "getTypeName");
}
__name(isTokenscriptSymbol, "isTokenscriptSymbol");
var typeEquals = /* @__PURE__ */ __name((typeA, typeB) => typeA?.toLowerCase() === typeB?.toLowerCase(), "typeEquals");
var typeName = /* @__PURE__ */ __name((base, sub) => {
...
var formatObjectEntries = /* @__PURE__ */ __name((data) => {
  let entries;
  if (isArray(data)) {
    entries = data;
  } else if (isMap(data)) {
...
var expectStringKey = /* @__PURE__ */ __name((key) => {
  if (isString(key)) {
    return key;
  }
...
var NullSymbol = class _NullSymbol extends BaseSymbolType {
  constructor(config) {
    super(null, config);
    this.type = "Null";
  }
  static {
    __name(this, "NullSymbol");
  }
  static {
    this.type = "Null";
  }
...
var NumberSymbol = class _NumberSymbol extends BaseSymbolType {
  constructor(value, config) {
    let safeValue;
    if (isNumber(value)) {
      safeValue = value;
  ...
  static {
    this._SUPPORTED_METHODS = {
      to_string: {
        name: "to_string",
        function: /* @__PURE__ */ __name(function(radix) {
...
var StringSymbol = class _StringSymbol extends BaseSymbolType {
  constructor(value, config) {
    let safeValue;
  ...
  static {
    this._SUPPORTED_METHODS = {
      upper: {
        function: /* @__PURE__ */ __name(function() {
          return this.upper();
        }, "function"),
        args: [],
        returnType: "String"
      ...
      concat: {
        function: /* @__PURE__ */ __name(function(other) {
      ...
      split: {
        function: /* @__PURE__ */ __name(function(delimiter) {
...
var BooleanSymbol = class _BooleanSymbol extends BaseSymbolType {
  constructor(value, config) {
    let safeValue;
...
var ListSymbol = class _ListSymbol extends BaseSymbolType {
  ...
  static {
    this._SUPPORTED_METHODS = {
      append: {
        function: /* @__PURE__ */ __name(function(item) {
      ...
      extend: {
        function: /* @__PURE__ */ __name(function(...items) {
      ...
      insert: {
        function: /* @__PURE__ */ __name(function(index, item) {
      ...
      delete: {
        function: /* @__PURE__ */ __name(function(index) {
      ...
      join: {
        function: /* @__PURE__ */ __name(function(separator) {
...
var NumberWithUnitSymbol = class _NumberWithUnitSymbol extends BaseSymbolType {
  ...
  static {
    __name(this, "NumberWithUnitSymbol");
  }
  static {
    this.type = "NumberWithUnit";
  }
...
var DictionarySymbol = class _DictionarySymbol extends BaseSymbolType {
  constructor(value, config) {
    let safeValue;
  ...
  static {
    this._SUPPORTED_METHODS = {
      get: {
        function: /* @__PURE__ */ __name(function(key) {
          return this.get(key);
        }, "function"),
      ...
      set: {
        function: /* @__PURE__ */ __name(function(key, value) {
...
var TokenSymbol = class _TokenSymbol extends BaseSymbolType {
  constructor(subType, value, config) {
    let safeValue;
  ...
  static {
    this._SUPPORTED_METHODS = {
      get: {
        function: /* @__PURE__ */ __name(function(keyOrIndex) {
  ...
  deepCopy() {
    if (isMap(this.value)) {
      return new _TokenSymbol(this.subType, DictionaryImpl.deepCopy(this.value), this.config);
    }
    return new _TokenSymbol(this.subType, ListImpl.deepCopy(this.value), this.config);
  }
  cloneIfMutable() {
    return this.deepCopy();
  }
...
var ColorSymbol = class _ColorSymbol extends BaseSymbolType {
...
var jsValueToSymbolType = /* @__PURE__ */ __name((value, config) => {
...
__name(serializeInterpreterResult, "serializeInterpreterResult");
function stringifyInterpreterResult(value) {
  if (isString(value)) return value;
  if (isTokenscriptSymbol(value)) return value.toString();
  return String(value);
}
__name(stringifyInterpreterResult, "stringifyInterpreterResult");
...
var ElementWithUnitNode = class {
  ...
  static {
    __name(this, "ElementWithUnitNode");
  }
};
...
var AttributeAccessNode = class {
  ...
  static {
    __name(this, "AttributeAccessNode");
  }
};
...
__name(getAssignmentInfo, "getAssignmentInfo");
...
__name(getReassignmentInfo, "getReassignmentInfo");
...
${contextText}`;
  ...
  typeDeclaration() {
    const baseTypeToken = this.eat("STRING" /* STRING */);
    const baseType = new IdentifierNode(baseTypeToken);
    const subTypes = [];
    while (this.currentToken.type === "DOT" /* DOT */) {
      this.eat("DOT" /* DOT */);
      const subTypeToken = this.eat("STRING" /* STRING */);
  ...
  statement() {
    ...
    } else if (this.currentToken.type === "STRING" /* STRING */) {
      const nextTokens = this.peekTokens(4);
      if (nextTokens !== null) {
        for (let i = 0; i < nextTokens.length - 1; i += 2) {
          if (nextTokens[i].type === "DOT" /* DOT */ && nextTokens[i + 1].type === "STRING" /* STRING */) {
  ...
  assignVariable() {
    ...
    const varNameToken = this.eat("STRING" /* STRING */);
...
var FunctionsManager = class _FunctionsManager extends BaseManager {
  ...
  setupBuiltinFunctions() {
    ...
    this.registerFunction("sum", (...args) => {
      ...
      if (!hasUnits) {
        const sum2 = args.reduce((acc, arg) => {
          if (arg instanceof NumberSymbol) return acc + arg.value;
      ...
      if (this.parentConfig?.unitManager) {
        try {
          ...
          const sum2 = converted.reduce((acc, arg) => {
      ...
      const sum = args.reduce((acc, arg) => {
        if (arg instanceof NumberSymbol) return acc + arg.value;
        if (arg instanceof NumberWithUnitSymbol) return acc + arg.value;
        if (typeof arg.value === "number") return acc + arg.value;
        throw new InterpreterError("FN_EXPECTS_NUMBER_ARGUMENTS" /* EXPECTS_NUMBER_ARGUMENTS */, {
          data: { functionName: "sum" }
        });
    ...
    this.registerFunction("mod", (a, b) => {
      let aVal, bVal;
      if (a instanceof NumberSymbol) aVal = a.value;
      else if (a instanceof NumberWithUnitSymbol) aVal = a.value;
      else if (typeof a.value === "number") aVal = a.value;
      else
        throw new InterpreterError("FN_EXPECTS_NUMBER_ARGUMENTS" /* EXPECTS_NUMBER_ARGUMENTS */, {
          data: { functionName: "mod" }
        });
      if (b instanceof NumberSymbol) bVal = b.value;
      else if (b instanceof NumberWithUnitSymbol) bVal = b.value;
      else if (typeof b.value === "number") bVal = b.value;
      else
        throw new InterpreterError("FN_EXPECTS_NUMBER_ARGUMENTS" /* EXPECTS_NUMBER_ARGUMENTS */, {
          data: { functionName: "mod" }
        });
    ...
    this.registerFunction("round", (arg) => {
      if (!(arg instanceof NumberSymbol))
        throw new InterpreterError("FN_EXPECTS_TYPE_ARGUMENT" /* EXPECTS_TYPE_ARGUMENT */, {
    ...
    this.registerFunction("abs", (arg) => {
      if (!(arg instanceof NumberSymbol))
        throw new InterpreterError("FN_EXPECTS_TYPE_ARGUMENT" /* EXPECTS_TYPE_ARGUMENT */, {
          data: { functionName: "abs", expectedType: "number", argumentPosition: "first" }
        });
      return new NumberSymbol(Math.abs(arg.value));
    });
    this.registerFunction("sqrt", (arg) => {
      if (!(arg instanceof NumberSymbol))
        throw new InterpreterError("FN_EXPECTS_TYPE_ARGUMENT" /* EXPECTS_TYPE_ARGUMENT */, {
          data: { functionName: "sqrt", expectedType: "number", argumentPosition: "first" }
        });
      return new NumberSymbol(Math.sqrt(arg.value));
    });
    this.registerFunction("pow", (base, exp) => {
      if (!(base instanceof NumberSymbol) || !(exp instanceof NumberSymbol))
        throw new InterpreterError("FN_EXPECTS_NUMBER_ARGUMENTS" /* EXPECTS_NUMBER_ARGUMENTS */, {
          data: { functionName: "pow" }
        });
      return new NumberSymbol(base.value ** exp.value);
    });
    ...
    this.registerFunction("sin", (arg) => {
      if (!(arg instanceof NumberSymbol))
        throw new InterpreterError("FN_EXPECTS_TYPE_ARGUMENT" /* EXPECTS_TYPE_ARGUMENT */, {
          data: { functionName: "sin", expectedType: "number", argumentPosition: "first" }
        });
      return new NumberSymbol(Math.sin(arg.value));
    });
    this.registerFunction("cos", (arg) => {
      if (!(arg instanceof NumberSymbol))
        throw new InterpreterError("FN_EXPECTS_TYPE_ARGUMENT" /* EXPECTS_TYPE_ARGUMENT */, {
          data: { functionName: "cos", expectedType: "number", argumentPosition: "first" }
        });
      return new NumberSymbol(Math.cos(arg.value));
    });
    this.registerFunction("tan", (arg) => {
      if (!(arg instanceof NumberSymbol))
        throw new InterpreterError("FN_EXPECTS_TYPE_ARGUMENT" /* EXPECTS_TYPE_ARGUMENT */, {
          data: { functionName: "tan", expectedType: "number", argumentPosition: "first" }
        });
      return new NumberSymbol(Math.tan(arg.value));
    });
    this.registerFunction("asin", (arg) => {
      if (!(arg instanceof NumberSymbol))
        throw new InterpreterError("FN_EXPECTS_TYPE_ARGUMENT" /* EXPECTS_TYPE_ARGUMENT */, {
    ...
    this.registerFunction("acos", (arg) => {
      if (!(arg instanceof NumberSymbol))
        throw new InterpreterError("FN_EXPECTS_TYPE_ARGUMENT" /* EXPECTS_TYPE_ARGUMENT */, {
    ...
    this.registerFunction("atan", (arg) => {
      if (!(arg instanceof NumberSymbol))
        throw new InterpreterError("FN_EXPECTS_TYPE_ARGUMENT" /* EXPECTS_TYPE_ARGUMENT */, {
          data: { functionName: "atan", expectedType: "number", argumentPosition: "first" }
        });
      return new NumberSymbol(Math.atan(arg.value));
    });
    this.registerFunction("atan2", (y, x) => {
      if (!(y instanceof NumberSymbol) || !(x instanceof NumberSymbol))
        throw new InterpreterError("FN_EXPECTS_NUMBER_ARGUMENTS" /* EXPECTS_NUMBER_ARGUMENTS */, {
          data: { functionName: "atan2" }
        });
      return new NumberSymbol(Math.atan2(y.value, x.value));
    });
    this.registerFunction("log", (arg, base) => {
      if (!(arg instanceof NumberSymbol))
        throw new InterpreterError("FN_EXPECTS_TYPE_ARGUMENT" /* EXPECTS_TYPE_ARGUMENT */, {
    ...
    this.registerFunction("floor", (arg) => {
      if (!(arg instanceof NumberSymbol))
        throw new InterpreterError("FN_EXPECTS_TYPE_ARGUMENT" /* EXPECTS_TYPE_ARGUMENT */, {
          data: { functionName: "floor", expectedType: "number", argumentPosition: "first" }
        });
      return new NumberSymbol(Math.floor(arg.value));
    });
    this.registerFunction("ceil", (arg) => {
      if (!(arg instanceof NumberSymbol))
        throw new InterpreterError("FN_EXPECTS_TYPE_ARGUMENT" /* EXPECTS_TYPE_ARGUMENT */, {
          data: { functionName: "ceil", expectedType: "number", argumentPosition: "first" }
        });
      return new NumberSymbol(Math.ceil(arg.value));
    });
    this.registerFunction(
      "round_to",
      (value, precision) => {
        ...
        if (precisionValue === 0) {
          const intPart2 = Math.floor(numValue);
          const fraction2 = numValue - intPart2;
          if (fraction2 === 0.5) {
            return new NumberSymbol(intPart2 % 2 === 0 ? intPart2 : intPart2 + 1);
          }
    ...
    this.registerFunction("pi", () => new NumberSymbol(Math.PI));
...
console.log("WELCOME TO TOKENSCRIPT");
...
var ColorManager = class _ColorManager extends BaseManager {
  ...
  registerConversions(uri, spec) {
    spec.conversions.forEach((conversion) => {
      ...
      const targetUri = conversion.target === "$self" ? uri : conversion.target;
      const { ast } = parseExpression(conversion.script.script);
      const fn = /* @__PURE__ */ __name((color) => {
...
${spec}`
  ...
  validate(tokenType, value, visitedUrls = /* @__PURE__ */ new Set(), basePath = [], depth = 0) {
    ...
    for (const [propName, propSpec] of Object.entries(spec.schema.properties)) {
   ...
   */
  runValidationScript(tokenType, value, path = []) {
    const normalizedType = tokenType.toLowerCase();
...
export { BaseSymbolType, BooleanSymbol, ColorManager, ColorSpecificationSchema, ColorSymbol, Config, DictionarySymbol, FunctionSpecificationSchema, Interpreter, InterpreterError, Lexer, LexerError, ListSymbol, NullSymbol, NumberSymbol, NumberWithUnitSymbol, Parser, ParserError, ProcessorError, StringSymbol, TokenSymbol, ensureArray, getAssignmentInfo, getKeyAlt, getReassignmentInfo, isArray, isBoolean, isLanguageError, isMap, isNone, isNull, isNumber, isObject, isString, isTokenscriptSymbol, jsValueToSymbolType, parseExpression, renameReferences, serializeInterpreterResult, stringifyInterpreterResult };
//# sourceMappingURL=chunk-2NMUBWBX.js.map
//# sourceMappingURL=chunk-2NMUBWBX.js.map